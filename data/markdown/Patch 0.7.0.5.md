...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.7.0.5** – Build 210096. This patch was released on 29 November 2022.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1047259910079004772), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/z86g6f), and [Steam](https://store.steampowered.com/news/app/526870/view/3485252139475043848). 
...
## Bug fixes
  ...
  * [Productivity calculation](/wiki/Productivity_Display "Productivity Display") has been changed so now hitches such as autosave shouldn’t cause productivity to drop
  * Fixed boomers clearance for [Blueprint](/wiki/Blueprint "Blueprint") holograms
  * [Walkways](/wiki/Walkway "Walkway") and [Pillars](/wiki/Pillars "Pillars") should now affect Blueprint size
  ...
  * Fixed a crash when placing a Blueprint in the [Blueprint designer](/wiki/Blueprint_Designer "Blueprint Designer")
  * Fixed deletion of Blueprints not properly propagating from Host to Clients
  * Fixed Advanced Game Settings menu not being able to be closed with [`Esc`](/wiki/Controls "Controls") after pressing Reset To Default or Apply buttons
  * Fixed issues related to [Lights](/wiki/Lights "Lights")
  * Fixed issues related to [Rain](/wiki/World#Lighting,_Sounds_and_Weather_\(Rain\) "World")
  ...
  * Fixed an issue where the [To-Do List](/wiki/To-Do_List "To-Do List") would lose focus after using the textboxes
