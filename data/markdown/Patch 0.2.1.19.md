...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.2.1.19** – Build . This patch was released on 26 November 2019. Stable [Patch 0.2.1.18](/wiki/Patch_0.2.1.18 "Patch 0.2.1.18") was released alongside.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/648893047186128906) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/e1ynfl). 
...
Hope you all have fun with the patch and see some performance increases on Experimental! Jace also made a video saying all of this stuff, here is the link: <https://www.youtube.com/watch?v=Z6ZTs31PuFE>
...
This patch also introduced content not mentioned in any patch notes, which was later officially introduced in [Patch 0.3](/wiki/Patch_0.3 "Patch 0.3"), most notably new ore meshes and "Spelevator Parts". 
