...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.8.1.3** – Build 249836. This patch was released on 5 September 2023.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1148673232795344976), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/16aunpr), and [Steam](https://store.steampowered.com/news/app/526870/view/3683435976317169597). 
...
## Bug fixes
  ...
  * Fixed an issue where the [Production Indicator lights](/wiki/Indicator_Light "Indicator Light") on buildings wouldn’t flash
  * Fixed [Signs](/wiki/Signs "Signs") not working properly on [Multiplayer](/wiki/Multiplayer "Multiplayer") or [Dedicated Server](/wiki/Dedicated_Server "Dedicated Server")
  * Fixed Screen Percentage setting not saving properly
  * Potential fix for some crashes related to [Conveyor](/wiki/Conveyor_Belt "Conveyor Belt") Renderer
