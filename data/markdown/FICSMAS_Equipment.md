...
During [FICSMAS](/wiki/FICSMAS "FICSMAS"), unique **equipment** can be crafted. Currently, this is only the Candy Cane Basher. Previously, Snowball Mittens were also available, the functionality of which was replaced by supporting different ammo types in the [Nobelisk Detonator](/wiki/Nobelisk_Detonator "Nobelisk Detonator").   
...
[ ](/wiki/File:Candy_Cane_Basher.png "Candy Cane Basher.png")

_Self-defense is now not only fun, but also delicious for the target! Do not lick or consume._

### Unlocked by

[MAM FICSMAS Holiday Event Research](/wiki/FICSMAS_Holiday_Event_Research "FICSMAS Holiday Event Research") \- Candy Cane Basher
...
The **Candy Cane Basher** is the FICSMAS variant of the [](/wiki/Xeno-Basher "Xeno-Basher") [Xeno-Basher](/wiki/Xeno-Basher "Xeno-Basher"). Both weapons are functionally identical, other than in appearance. 

### Unlocking

The Candy Cane Basher is unlocked via the FICSMAS Research chain in the [](/wiki/MAM "MAM") [MAM](/wiki/MAM "MAM"). 

### Equipment

_Main article:_[Xeno-Basher](/wiki/Xeno-Basher "Xeno-Basher")
...
---|---|---|---|---  
Candy Cane Basher  
FICSMAS | 2 × [](/wiki/Xeno-Zapper "Xeno-Zapper")Xeno-Zapper1.5 / min25 × [](/wiki/Candy_Cane "Candy Cane")Candy Cane18.75 / min15 × [](/wiki/FICSMAS_Gift "FICSMAS Gift")FICSMAS Gift11.25 / min | [Equipment Workshop](/wiki/Equipment_Workshop "Equipment Workshop")  
× 40 | 1 × [](/wiki/Candy_Cane_Basher "Candy Cane Basher")Candy Cane Basher0.75 / min | [MAM FICSMAS Holiday Event Research](/wiki/FICSMAS_Holiday_Event_Research "FICSMAS Holiday Event Research") \- Candy Cane Basher   
  
### AWESOME Sink

**[](/wiki/Candy_Cane_Basher "Candy Cane Basher")[Candy Cane Basher](/wiki/Candy_Cane_Basher "Candy Cane Basher")** can be sunk into the [](/wiki/AWESOME_Sink "AWESOME Sink") [AWESOME Sink](/wiki/AWESOME_Sink "AWESOME Sink") to yield **7,850 points**.

## See also

  * [FICSMAS Parts](/wiki/FICSMAS/Parts "FICSMAS/Parts")
  * [FICSMAS Buildings](/wiki/FICSMAS/Buildings "FICSMAS/Buildings")
