...
Patch Notes: **THURSDAY NIGHT 2018-10-11** – Build 87740. This version was released on October 11, 2018. The original post came from the main menu of a pre-Closed Alpha build. Information on this page comes from a video,[1] and may be incomplete.   
...
**New Things in Current Build**

We've done a bunch of things the previous months. Future updates will be more detailed but here is a short summary of the latest: 

## World

  * Areas alpha ready: 
    * [Grass Fields](/wiki/Grass_Fields "Grass Fields") starting area
    * [Western Dune Forest](/wiki/Western_Dune_Forest "Western Dune Forest") early game area (northwest of Grass Fields)
    * [Southern Forest](/wiki/Southern_Forest "Southern Forest") (east of Grass Fields)
  * Sky, planets & fog update
  * Day & Night time balance: Shorter night
  * [Resource Node](/wiki/Resource_Node "Resource Node") redesign
...
## Intro & Onboarding
  ...
  * Intro sequence
  * [Hub](/wiki/Hub "Hub") progression / start of game
  * Implementation of [Test Narrative](/wiki/Onboarding "Onboarding")



## Buildings

  * Foundation, Wall & Ramp redesign



## References

  1. ↑ [https://www.youtube.com/watch?v=0V-AXUgbhPM&t=20](https://www.youtube.com/watch?v=0V-AXUgbhPM&t=20)
