...
The **Flashlight** [`B`](/wiki/Controls "Controls") is used to light a small circular area in front of the [pioneer](/wiki/Pioneer "Pioneer"), which is useful for navigation in dark areas or at night. 

As it does not consume any fuel or energy, it can remain lit forever, even after save-load, or until the pioneer chooses to switch it off. The light returns to the off state after the pioneer has died, however. 

Other [pioneers](/wiki/Pioneer "Pioneer") can see the light emitting from the pioneer's head with a small cloud of dust, illuminated by the cone of light. 

## Unlocking

The Flashlight is unlocked when the pioneer has mined [Iron Ore](/wiki/Iron_Ore "Iron Ore") for the first time. 

## Range

The effective range of the Flashlight is about 75 meters. Beyond that, the light intensity drops abruptly. 

## History

  * [Patch 1.1.0.0](/wiki/Patch_1.1.0.0 "Patch 1.1.0.0"): Added long requested QOL for traveling inside [Hypertubes](/wiki/Hypertube "Hypertube") during nighttime with improved visibility
