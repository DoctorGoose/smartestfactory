...
_Provides a good vantage point to facilitate factory construction._

### Unlocked by

[Tier 1](/wiki/Tier_1 "Tier 1") \- Base Building
...
The tower comes with a ladder at the central frame to allow the [pioneer](/wiki/Pioneer "Pioneer") to climb onto the platform, which is elevated 18 meters from its foundation. [Fall damage](/wiki/Fall_damage "Fall damage") will be taken when jumping off of the tower unless [Blade Runners](/wiki/Blade_Runners "Blade Runners") are equipped. While standing on it, Lookout Towers can provide limited support for factory constructions, [Power Slug](/wiki/Power_Slug "Power Slug") and [artifact](/wiki/Artifact "Artifact") hunting, reaching high places, to name a few. 

To reach even higher places, consider building chained [Ladders](/wiki/Ladder "Ladder") instead. 

## See also

  * [](/wiki/Radar_Tower "Radar Tower") [Radar Tower](/wiki/Radar_Tower "Radar Tower")
...
A Lookout Tower built on a hill.
  ...
  * [](/wiki/File:Empty_platform_night.png "A Train Station and an Empty Platform. The Lookout Tower was built earlier on a Foundation 8m x 1m which the foundation was removed afterward.")

A [Train Station](/wiki/Train_Station "Train Station") and an [Empty Platform](/wiki/Empty_Platform "Empty Platform"). The Lookout Tower was built earlier on a [Foundation 8m x 1m](/wiki/Foundation_8m_x_1m "Foundation 8m x 1m") which the foundation was removed afterward.
