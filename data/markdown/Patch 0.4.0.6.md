...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.4.0.6** – Build 148606. This patch was released on 29 March 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/826141673540288592), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/mfuc92), and [Steam](https://store.steampowered.com/news/app/526870/view/3019074494740092492). 
...
## Bug fixes
  ...
  * Fixed [Drone Station](/wiki/Drone_Port "Drone Port") Inventory not working for [Client](/wiki/Multiplayer "Multiplayer")
  * [Drone](/wiki/Drone "Drone") Pathfinding and [World](/wiki/World "World") Grid improvements. Drones will now fly to the closest cell if trying to pathfind outside of the grid instead of crashing. Building outside of the grid might have some weird behaviour but shouldn’t cause crashes anymore
  ...
  * Fixed [Nobelisk](/wiki/Nobelisk "Nobelisk") sound delay bug on destructible boulders
...
## Optimisation
  ...
  * Optimized VFX for the [Fuel Generator](/wiki/Fuel_Generator "Fuel Generator")
