...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.3.4.6** – Build 120739. This patch was released on 29 April 2020.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/705024949328412782) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/ga81xa). 
...
Today's patch should fix the issue of despawning [Lizard Doggos](/wiki/Lizard_Doggo "Lizard Doggo") and introduce an overflow setting for your [Smart](/wiki/Smart_Splitter "Smart Splitter") & [Programmable Splitters](/wiki/Programmable_Splitter "Programmable Splitter")! There are some additional fixes and tweaks coming with it that you can check out in the notes below. 

In the last patch we updated the [fluid](/wiki/Fluid "Fluid") simulation to properly work below Z-0 in the world. If you are now experiencing issues with your fluids it could mean that your setup has been relying on the bugs that we fixed. In that case you might have to revisit your setup and make sure it is working properly and uses the correct number and placement of [pumps](/wiki/Pipeline_Pump "Pipeline Pump"). 
...
## Balancing
  ...
  * [Power Shards](/wiki/Power_Shard "Power Shard") production times changed to work better with [Constructor](/wiki/Constructor "Constructor") sounds
  * [Color Cartridge](/wiki/Color_Cartridge "Color Cartridge") production cycle shortened, production values are unchanged



## New feature

  * Overflow setting on [Smart](/wiki/Smart_Splitter "Smart Splitter") & [Programmable Splitter](/wiki/Programmable_Splitter "Programmable Splitter")
...
## Bug fixes
  ...
  * Clients should now be able to correctly build and snap [Freight Cars](/wiki/Freight_Car "Freight Car")
  * [Lizard Doggos](/wiki/Lizard_Doggo "Lizard Doggo") should now actually not despawn
  * [Weapons](/wiki/Combat "Combat") should no longer keep firing if primary fire was held down while switching to the [build gun](/wiki/Build_Gun "Build Gun") or dismantle gun.
  * Fixed instancing on [Window Walls](/wiki/Walls "Walls")
  * Fixed a crash on load related to [power](/wiki/Power "Power") circuits
  * Dismantle effect should no longer persist if the [Build Gun](/wiki/Build_Gun "Build Gun") is unequipped while dismantling
  * [Fluid Buffers](/wiki/Fluid_Buffer "Fluid Buffer"), [Freight Platforms](/wiki/Freight_Platform "Freight Platform") and [Freight Car](/wiki/Freight_Car "Freight Car") now state the correct capacity of the buildings in their description
  * Fixed incorrect material application on the [Smelter](/wiki/Smelter "Smelter") and [Foundry](/wiki/Foundry "Foundry")
