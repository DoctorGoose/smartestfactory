...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.4.0.8** – Build 149233. This patch was released on 1 April 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/827240293921325087), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/mi0z0q), and [Steam](https://store.steampowered.com/news/app/526870/view/3015697429654782682). 

## Contents

  * 1 Intro
  * 2 Balancing
    * 2.1 Exact Standard recipe changes
    * 2.2 Exact Alternative recipe changes
...
## Balancing
  ...
  * Increased the [Bauxite](/wiki/Bauxite "Bauxite") usage on most alternative recipes using Bauxite or Aluminum parts.
  * Increased Aluminum usage of [Radio Control Units](/wiki/Radio_Control_Unit "Radio Control Unit") and [Heat Sinks](/wiki/Heat_Sink "Heat Sink") (Standard recipes).
  * Rebalanced [Plutonium Fuel Rod](/wiki/Plutonium_Fuel_Rod "Plutonium Fuel Rod") standard recipe, increased power yield, and reduced [Plutonium Waste](/wiki/Plutonium_Waste "Plutonium Waste") production.
  * Rebalanced all Alternative Plutonium Recipes.
  * Fixed and rebalanced [Infused Uranium Cell](/wiki/Encased_Uranium_Cell "Encased Uranium Cell") recipe.
...
### Exact Standard recipe changes
  ...
  * [Encased Plutonium Cells](/wiki/Encased_Plutonium_Cell "Encased Plutonium Cell") output at half the rate to match new Plutonium Fuel Rod production.
  * Fixed up a mistake made with the [Non-fissile Uranium](/wiki/Non-fissile_Uranium "Non-fissile Uranium") standard recipe (the numbers for Sulfuric Acid and Nitric Acid were swapped... oops).
  * Halved Plutonium Waste output per minute (was 2 per [generator](/wiki/Nuclear_Power_Plant "Nuclear Power Plant"), is now 1).



### Exact Alternative recipe changes

  * [Sloppy Alumina](/wiki/Alumina_Solution "Alumina Solution") & Electro: 
    * Aluminum Scrap: Adapted the numbers and increased bauxite usage.
  * [Instant (Aluminum) Scrap](/wiki/Aluminum_Scrap "Aluminum Scrap"): 
    * Adapted numbers for water (input and output).
  * [Pure Aluminum Ingot](/wiki/Aluminum_Ingot "Aluminum Ingot"): 
    * Slightly increased both input and output rate (ratios are the same).
  * [Alclad Casing](/wiki/Aluminum_Casing "Aluminum Casing"): 
    * Increased Aluminum Ingot usage.
  * [Radio Control System](/wiki/Radio_Control_Unit "Radio Control Unit"): 
    * Increased Aluminum Casing usage.
  * [Heat Exchanger](/wiki/Heat_Sink "Heat Sink"): 
    * Increased usage of Aluminum Casing by 100% and Rubber by 50%.
  * [Cooling Device](/wiki/Cooling_System "Cooling System"): 
    * Increased Heat Sink usage.
  * [Turbo Rigour Motor](/wiki/Turbo_Motor "Turbo Motor"): 
    * Renamed to Turbo Electric Motor, decreased Electromagnetic Control Rod and Rotor usage, increased Radio Control Unit.
  * [Turbo Pressure Motor](/wiki/Turbo_Motor "Turbo Motor"): 
    * Reduced Packaged Nitrogen, Pressure Conversion Cube, and Stator usage.
  * [Infused Uranium Cell](/wiki/Encased_Uranium_Cell "Encased Uranium Cell"): 
    * Properly uses Uranium instead of Uranium Pellets now, did another balance pass while we were at it.
  * [Non-fissile Uranium](/wiki/Non-fissile_Uranium "Non-fissile Uranium"): 
    * Reduced Nitric and Sulfuric Acid usage, reduced water output.
  * [Instant Plutonium Cell](/wiki/Encased_Plutonium_Cell "Encased Plutonium Cell"): 
    * Reduced Nitrogen usage, halved output rate to match new Plutonium Fuel Rod balance
  * [Plutonium Fuel Unit](/wiki/Plutonium_Fuel_Rod "Plutonium Fuel Rod"): 
