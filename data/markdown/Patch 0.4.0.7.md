...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.4.0.7** – Build 149006. This patch was released on 31 March 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/826863348779319397), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/mhaj53), and [Steam](https://store.steampowered.com/news/app/526870/view/3015697429651026432). 
...
## Bug fixes
  ...
  * Fixed missing sounds in [Geyser](/wiki/Geyser "Geyser") nodes
  * Attempt #4 at fixing the UFGReplicationDetailInventoryComponent crash
  * Fixed Sort button not working in [Vehicle](/wiki/Vehicle "Vehicle") Storages
  * Fixed [Clients](/wiki/Multiplayer "Multiplayer") not being able to see Information in [Drone Ports](/wiki/Drone_Port "Drone Port")
  * Fixed issues with items not rendering properly in [conveyor belts](/wiki/Conveyor_Belt "Conveyor Belt") #PraiseBen
  * Fixed [Light](/wiki/Lights "Lights") Intensity in UI displaying as 1000% instead of 100%
...
## April Fools' changes
  ...
  * Made [Lizard Doggos](/wiki/Lizard_Doggo "Lizard Doggo") larger, and some of them wearing the [Pioneer](/wiki/Pioneer "Pioneer") helmet
  * Made [Space Giraffe-Tick-Penguin-Whale Thing](/wiki/Space_Giraffe-Tick-Penguin-Whale_Thing "Space Giraffe-Tick-Penguin-Whale Thing") smaller
  * Made [Hogs](/wiki/Hog "Hog") look like the [Walker](/wiki/Walker "Walker")
  * Made [Pioneer](/wiki/Pioneer "Pioneer") helmets larger
  * Randomized the capitalization of resource names in the [Resource Scanner](/wiki/Resource_Scanner "Resource Scanner"), except for [Coal](/wiki/Coal "Coal")
  * Made some [Flora](/wiki/Flora "Flora") replaced with random [equipment](/wiki/Equipment "Equipment"), which made it appear in strange sizes, and sometimes in mid-air
