...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.2.1.11** – Build 103023. This patch was released on 9 August 2019.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/609407980575916052) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/co3xh2). 
...
## UI
  ...
  * Little overhaul of the Photo Mode UI, including a rule of thirds overlay Increased font size on the Power Graph
...
## Optimisation
  ...
  * Some sneaky optimisations. Let us know how your FPS are doing after this update
  * Additional LOD (Level of Detail) optimisations
  * Optimised Factory Building materials (will affect memory overhead and the maximum number of Uobject crash for enormous factories)
