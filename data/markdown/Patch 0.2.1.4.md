...
Patch Notes: Early Access – **v0.2.1.4** – Build 102279. This patch was released on 18 July 2019.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/601379156315602964) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/cerfrz). 
...
About two hours after release, the patch was rolled back. Its content was then introduced in [Patch 0.2.1.5](/wiki/Patch_0.2.1.5 "Patch 0.2.1.5"). 

    Seems like this patch has introduced a bunch of problems! We are rolling it back to the previous version (Build 102023) and will update again when we fixed those issues. Sadly, that means you might have to wait for the stuff we added until next week.
    Cheers <3
...
Hope you enjoy this little update! Let us know if we broke anything. 

PS: Most of us are still on vacation, so the office is fairly empty right now. It’s pretty cozy actually, but it means there are some bugs we can’t address yet, even if they are really annoying. We’ll be back at it with the whole team Soon™ <3 
...
## UI
  ...
  * The search bar in the Build Menu is now always visible and pressing the space bar gives focus to it
...
Update 2| [0.2.1](/wiki/Patch_0.2.1 "Patch 0.2.1") • [0.2.1.1](/wiki/Patch_0.2.1.1 "Patch 0.2.1.1") • [0.2.1.2](/wiki/Patch_0.2.1.2 "Patch 0.2.1.2") • [0.2.1.3](/wiki/Patch_0.2.1.3 "Patch 0.2.1.3") •  0.2.1.4 • [ 0.2.1.5](/wiki/Patch_0.2.1.5 "Patch 0.2.1.5") • [0.2.1.7](/wiki/Patch_0.2.1.7 "Patch 0.2.1.7") • [0.2.1.10](/wiki/Patch_0.2.1.10 "Patch 0.2.1.10") • [0.2.1.12](/wiki/Patch_0.2.1.12 "Patch 0.2.1.12") • [0.2.1.17](/wiki/Patch_0.2.1.17 "Patch 0.2.1.17") • [0.2.1.18](/wiki/Patch_0.2.1.18 "Patch 0.2.1.18")  
