...
[](/wiki/File:Xeno-Zapper.png "Stub") | _This article is a[stub](/wiki/Category:Stubs "Category:Stubs"). You can help Satisfactory Wiki by [expanding it](https://satisfactory.wiki.gg/wiki/Basic_Shelf_Unit?action=edit)._  
---|---  
  
_This article is a[stub](/wiki/Category:Stubs "Category:Stubs"). You can help Satisfactory Wiki by [expanding it](https://satisfactory.wiki.gg/wiki/Basic_Shelf_Unit?action=edit)._  


## Basic Shelf Unit

[ ](/wiki/File:Basic_Shelf_Unit.png "Basic Shelf Unit.png")

_A stackable shelf. Each one can hold two Personal Storage Boxes._

### Unlocked by

[AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Basic Shelf Unit
...
**1 ×[](/wiki/Iron_Rod "Iron Rod") [Iron Rod](/wiki/Iron_Rod "Iron Rod")**

The **Basic Shelf Unit** is a decorative structure which allows [Personal Storage Boxes](/wiki/Personal_Storage_Box "Personal Storage Box") to be built in an orderly manner. 

Shelf Units can be stacked to create larger shelves. 

## History

  * [Patch 1.1.0.2](/wiki/Patch_1.1.0.2 "Patch 1.1.0.2"): Fixed snapping points in the bottom part of the Basic Shelf Unit
