...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.8.0.4** – Build 239901. This patch was released on 21 June 2023.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1121041031048212560), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/14f56zr), and [Steam](https://store.steampowered.com/news/app/526870/view/3669918835613286944). 
...
## Bug fixes
  ...
  * Fixed the [customizer](/wiki/Customizer "Customizer") still consuming resources from inventory when No Build Cost was enabled
  ...
  * Potentially fixed a crash related to [conveyor belt](/wiki/Conveyor_Belt "Conveyor Belt") holograms
  * Potentially fixed a crash when loading a save that might be affecting saves that have [Geothermal power](/wiki/Geothermal_Generator "Geothermal Generator") set up
...
## UI
  ...
  * Added a button to [the new Wiki](https://satisfactory.wiki.gg/) to the Social Media buttons in the main menu and rearranged the buttons
...
## Gameplay
  ...
  * Reduced the height at which the player hangs from the [Zipline](/wiki/Zipline "Zipline"), this should help some cases where the player gets detached from the cable when ziplining down an incline due to bumping the Pioneer’s head
