# Template:IconLink/zh

[[File:{{{default}}}.png|20px|link={{{1}}}]] [[{{{1}}}|{{{1}}}]] 

[](/wiki/File:Template-info.svg) Documentation

[[purge](https://satisfactory.wiki.gg/wiki/Template:IconLink/zh?action=purge)]
...
The above documentation is transcluded from [Template:IconLink/zh/doc](/wiki/Template:IconLink/zh/doc "Template:IconLink/zh/doc"). ([edit](https://satisfactory.wiki.gg/wiki/Template:IconLink/zh/doc?action=edit) | [history](https://satisfactory.wiki.gg/wiki/Template:IconLink/zh/doc?action=history))
