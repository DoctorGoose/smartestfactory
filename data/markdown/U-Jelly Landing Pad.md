...
[ ](/wiki/File:U-Jelly_Landing_Pad.png "U-Jelly Landing Pad.png")

_Generates a speed-dampening jelly.  
Guarantees a safe landing._

### Unlocked by

[Tier 2](/wiki/Tier_2 "Tier 2") \- Jump Pads
...
**20 ×[](/wiki/Cable "Cable") [Cable](/wiki/Cable "Cable")**

**200 ×[](/wiki/Biomass "Biomass") [Biomass](/wiki/Biomass "Biomass")**

The **U-Jelly Landing Pad** is a [building](/wiki/Building "Building") that, _when powered_ , generates a viscous green jelly cylinder that significantly slows movement while immersed. Landing onto the jelly part of the Landing Pad will prevent [pioneers](/wiki/Pioneer "Pioneer") from taking [fall damage](/wiki/Fall_damage "Fall damage"). 

U-Jelly Landing Pads can prevent fall damage from any height, even from the 'top' portion of the [Space Elevator](/wiki/Space_Elevator "Space Elevator").[1]
...
## Trivia
  ...
  * While in the Jelly, the game screen is tinted green, and sounds will be muffled
  * [Pioneers](/wiki/Pioneer "Pioneer") will not suffocate in the jelly.
  * While Pioneer is within a U-Jelly Landing Pad a [Boom Box](/wiki/Boom_Box "Boom Box") tape play (speed) slows down.[2]
...
## See also
  ...
  * [](/wiki/Jump_Pad "Jump Pad") [Jump Pad](/wiki/Jump_Pad "Jump Pad")



## Gallery

  * [](/wiki/File:Jump_Pad_and_Landing_Pad.png "Use Jump Pad to travel upwards, and use U-Jelly Landing Pad for returning to the ground level safely.")

Use Jump Pad to travel upwards, and use U-Jelly Landing Pad for returning to the ground level safely.

  * [](/wiki/File:U-Jelly_Landing_Pad_Inactive.png "An inactive U-Jelly Landing Pad")

An inactive U-Jelly Landing Pad

  * [](/wiki/File:U-Jelly_Landing_Pad_Active.png "An active U-Jelly Landing Pad")

An active U-Jelly Landing Pad
...
## History
  ...
  * [Patch 0.4.0.4](/wiki/Patch_0.4.0.4 "Patch 0.4.0.4"): Now can be rotated 45 degrees when placing instead of only 90 degrees
  * [Patch 0.1.14](/wiki/Patch_0.1.14 "Patch 0.1.14"): Fixed a fall damage issue



## Early game development

Prior to Closed Alpha, in Sprint 26 (week 52) the U-Jelly Landing Pad first appeared along with the Jump Pad and Tilted Jump Pad. 

  * See also: [Game Development - U-Jelly Landing Pad](/wiki/Early_game_development#U-Jelly_Landing_Pad "Early game development")



## References

  1. ↑ [YouTube - Satisfactory Is it good? Early Access Preview Review - Landing in U-Jelly Landing Pad](https://www.youtube.com/watch?v=8WA-uwJzCHA&t=692)
  2. ↑ [YouTube - Boombox plays slow-mo in jelly landing pad](https://www.youtube.com/watch?v=scGhJ-fyL0I)
