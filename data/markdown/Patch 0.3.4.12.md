...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.3.4.12** – Build 123093. This patch was released on 27 May 2020.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/715240677125914766) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/grmzr9). 
...
## Factory
  ...
  * Added new meshes for all [Train Platforms](/wiki/Freight_Platform "Freight Platform")
...
## UI
  ...
  * Added tooltips for [Smart](/wiki/Smart_Splitter "Smart Splitter")/[Programmable Splitter](/wiki/Programmable_Splitter "Programmable Splitter") settings to clarify their purposes
...
## Bug fixes
  ...
  * Client players can now set standby in [Generators](/wiki/Power "Power")
  * [Dismantle](/wiki/Dismantle "Dismantle") is now available in the [Codex](/wiki/Codex "Codex") step during [Onboarding](/wiki/Onboarding "Onboarding")
  * [Resource Scanner](/wiki/Resource_Scanner "Resource Scanner") now works after being revived
  * Client players can now see the starting [Drop Pod](/wiki/Drop-pod "Drop-pod")
  * Set 0 second researches to 3 seconds in the [MAM](/wiki/MAM "MAM") to solve invisible completion problem for Client players
