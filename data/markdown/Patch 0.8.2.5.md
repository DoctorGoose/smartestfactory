...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.8.2.5** – Build 262332. This patch was released on 30 October 2023.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1168602006928240723), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/17jynqa), and [Steam](https://store.steampowered.com/news/app/526870/view/3753246843724622631). 
...
## Bug fixes
  ...
  * Fixed a crash for clients that sometimes occurred when trying to snap a [Power Pole](/wiki/Power_Pole "Power Pole") to a [Power Line](/wiki/Power_Line "Power Line")
  * Crash guard for modded/modified saves when trying to upgrade a [Building](/wiki/Building "Building") which has dangling wires
  * Fixed [Crab Hatcher](/wiki/Flying_Crab_Hatcher "Flying Crab Hatcher") respawning
  * Fixed [Asphalt foundation](/wiki/Foundations "Foundations") displaying patterns applied to them incorrectly
