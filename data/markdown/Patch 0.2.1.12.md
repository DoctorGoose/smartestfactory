...
Patch Notes: Early Access – **v0.2.1.12** – Build 103400. This patch was released on 20 August 2019.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/613354807381458965) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/csybkf). 
...
## Bug fixes
  ...
  * Names should show up on the [Compass](/wiki/Compass "Compass") again
  * Trains should now be properly shown on the [Compass](/wiki/Compass "Compass")
  * Hovering over [Conveyor Belts](/wiki/Conveyor_Belts "Conveyor Belts") in Dismantle Mode won’t change their Belt to Mk.1 anymore
  * Fixed an issue where some players would get no colour assigned to them in multiplayer
  * Fixed some [Conveyor Belt](/wiki/Conveyor_Belt "Conveyor Belt") crashes
...
## Factory
  ...
  * Added “Any Undefined” rule for the [Smart](/wiki/Smart_Splitter "Smart Splitter") & [Programmable](/wiki/Programmable_Splitter "Programmable Splitter") Splitter, which only sends items through that are not defined to go to any other output



## World

  * Fixes, tweaks and optimisation for some foliage assets (Grass, Licuala Palm Tree, Blue Palm, Cat Palm, Yellow Field Flower)
...
## Optimisation
  ...
  * Some sneaky optimisations. Let us know how you’re FPS are doing after this update
  * Additional LOD (Level of Detail) optimisations
  * Optimised Factory Building materials (will improve memory overhead and the maximum number of Uobject crash for enormous factories)
...
Update 2| [0.2.1](/wiki/Patch_0.2.1 "Patch 0.2.1") • [0.2.1.1](/wiki/Patch_0.2.1.1 "Patch 0.2.1.1") • [0.2.1.2](/wiki/Patch_0.2.1.2 "Patch 0.2.1.2") • [0.2.1.3](/wiki/Patch_0.2.1.3 "Patch 0.2.1.3") • [ 0.2.1.4](/wiki/Patch_0.2.1.4 "Patch 0.2.1.4") • [ 0.2.1.5](/wiki/Patch_0.2.1.5 "Patch 0.2.1.5") • [0.2.1.7](/wiki/Patch_0.2.1.7 "Patch 0.2.1.7") • [0.2.1.10](/wiki/Patch_0.2.1.10 "Patch 0.2.1.10") • 0.2.1.12 • [0.2.1.17](/wiki/Patch_0.2.1.17 "Patch 0.2.1.17") • [0.2.1.18](/wiki/Patch_0.2.1.18 "Patch 0.2.1.18")  
