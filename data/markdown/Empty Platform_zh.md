...
[](/wiki/File:Stub.svg "Outdated") | _This article is[outdated](/wiki/Category:Outdated "Category:Outdated"). You can help Satisfactory Wiki by [updating it](https://satisfactory.wiki.gg/wiki/Empty_Platform/zh?action=edit)._  
---|---  
  
_This article is[outdated](/wiki/Category:Outdated "Category:Outdated"). You can help Satisfactory Wiki by [updating it](https://satisfactory.wiki.gg/wiki/Empty_Platform/zh?action=edit)._  
...
[ ](/wiki/File:Empty_Platform.png "Empty Platform.png")

_Creates empty space where necessary._
...
[ ](/wiki/File:Empty_Platform_With_Catwalk.png "Empty Platform With Catwalk.png")
...
A blank platform is a railway structure used to space freight platforms to allow for proper loading/unloading of freight cars. They can be connected to railway stations, freight platforms and other empty platforms. There are two decorative variants of the empty platform: the flat empty platform and the empty platform with walkways, the latter having double walkways at the same height that can be connected with walkways. 

The empty platform is not only a decorative building, but also has some practical functions. They avoid the need to build more expensive regular platforms where cargo needs to be loaded or unloaded, saving building materials and requiring no electricity. Additionally, empty platforms can be used to space multiple electric locomotives between trains. For example, when a train has two locomotives at the front and requires a platform gap between the station and the first unloading truck, an empty platform comes in handy. 

Unlike other station buildings, empty platforms with walkways have no supports to support the walkways. If built individually, the walkway would be suspended in the air 
...
## Gallery
  ...
  * [](/wiki/File:Empty_platform_night.png)
...
## History
  ...
  * [Patch 0.5.0.0](/wiki/Patch_0.5.0.0 "Patch 0.5.0.0"): Introducing empty platforms with walkways
  * [Patch 0.3.4.16](/wiki/Patch_0.3.4.16 "Patch 0.3.4.16"):Fix excessive track gaps


  * [Patch 0.3.4.15](/wiki/Patch_0.3.4.15 "Patch 0.3.4.15"): Integrated station rails should no longer rotate separately from the main building
  * [Patch 0.3.4.14](/wiki/Patch_0.3.4.14 "Patch 0.3.4.14"): update icon
  * [Patch 0.3.4.13](/wiki/Patch_0.3.4.13 "Patch 0.3.4.13"): Add more details to the mesh
  * [Patch 0.3.4.12](/wiki/Patch_0.3.4.12 "Patch 0.3.4.12"): Add new grid


  * [Patch 0.3.4.15](/wiki/Patch_0.3.4.15 "Patch 0.3.4.15"): Collision box height reduced to 1 meter. This allows other buildings to be built on the platform (but not docked directly on it). The previous height was the same as the other platforms.
  * [Patch 0.2.1.4](/wiki/Patch_0.2.1.4 "Patch 0.2.1.4"): Update LODs
  * [Patch 0.2.1.3](/wiki/Patch_0.2.1.3 "Patch 0.2.1.3") Fixed a crash that could occur when building a train platform/station between two other platforms/stations
  * [Patch 0.1.19](/wiki/Patch_0.1.19 "Patch 0.1.19"): Add bracket
  * [Patch 0.1.16](/wiki/Patch_0.1.16 "Patch 0.1.16"): Introducing an empty platform
