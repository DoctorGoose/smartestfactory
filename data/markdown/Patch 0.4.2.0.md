...
Patch Notes: Early Access – **v0.4.2.0** – Build 151248. This patch was released on 20 April 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/834124999866581063), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/muw74d), and [Steam](https://store.steampowered.com/news/app/526870/view/4461354274046817472). 
...
## Bug fixes
  ...
  * Fixed holograms not displaying properly in [Dune Desert](/wiki/Dune_Desert "Dune Desert") or after having been in Dune Desert



## Equipment

  * Adjusted the [Hover Pack](/wiki/Hover_Pack "Hover Pack") to explain its “Disable” and “Slow-fall” controls.
...
Update 4| [0.4.1.0](/wiki/Patch_0.4.1.0 "Patch 0.4.1.0") • [0.4.1.1](/wiki/Patch_0.4.1.1 "Patch 0.4.1.1") • 0.4.2.0 • [0.4.2.2](/wiki/Patch_0.4.2.2 "Patch 0.4.2.2") • [0.4.2.5](/wiki/Patch_0.4.2.5 "Patch 0.4.2.5") • [0.4.2.7](/wiki/Patch_0.4.2.7 "Patch 0.4.2.7") • [0.4.2.9](/wiki/Patch_0.4.2.9 "Patch 0.4.2.9") • [0.4.2.11](/wiki/Patch_0.4.2.11 "Patch 0.4.2.11")  
