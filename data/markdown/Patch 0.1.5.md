...
[](/wiki/File:Update1_Sign_Logo.png)  
  
Patch Notes: Early Access (EXPERIMENTAL) – **v0.1.5** – Build 98224. This patch was released on 30 April 2019. It is the first patch of Update 1 development. 

The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/572807090427658272) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/bj4oft). 
...
## New features
  ...
  * Added the [Conveyor Lift](/wiki/Conveyor_Lift "Conveyor Lift") (currently with placeholder visuals) 
    * Rebuild or build a new factory with Mk.1 - 4 of the vertical Conveyor Belt!
  * Added the Quartz Research 
    * New Parts and Recipes: [Quartz Crystal](/wiki/Quartz_Crystal "Quartz Crystal"), [Crystal Oscillator](/wiki/Crystal_Oscillator "Crystal Oscillator")
    * [Explorer](/wiki/Explorer "Explorer") Vehicle: The vehicle currently best suited for traversal
    * Ingame [Map](/wiki/Map "Map"): Enjoy revealing the game map via exploration and the [Radar Tower](/wiki/Radar_Tower "Radar Tower")
  * Added the [Sulfur](/wiki/Sulfur "Sulfur") Research 
    * New Parts and Recipes: [Sulfur](/wiki/Sulfur "Sulfur"), [Gunpowder](/wiki/Gunpowder "Gunpowder"), [Explosives](/wiki/Nobelisk "Nobelisk"), [Ammunition](/wiki/Cartridge "Cartridge")
    * [Nobelisk Detonator](/wiki/Nobelisk_Detonator "Nobelisk Detonator"): Blow up trees, bushes, rocks, creatures and friends
    * [Rifle](/wiki/Rifle "Rifle") Mk.1: An automatic rifle for the purpose of Pioneer safety



## Balancing

  * Added several new [alternate Recipes](/wiki/Hard_Drive#Alternative_Recipes "Hard Drive")
  ...
  * [Fabric](/wiki/Fabric "Fabric") recipe now requires [Biomass](/wiki/Biomass "Biomass") instead of [Leaves](/wiki/Leaves "Leaves")
  * Fixed the [milestone](/wiki/Milestone "Milestone") cost of the Alternate [Heavy Modular Frame](/wiki/Heavy_Modular_Frame "Heavy Modular Frame")
  * Clearance adjustments for several buildings to fit more snugly 
    * [Splitter](/wiki/Conveyor_Splitter "Conveyor Splitter") and [Merger](/wiki/Conveyor_Merger "Conveyor Merger")
    * [Smelter](/wiki/Smelter "Smelter"), [Constructor](/wiki/Constructor "Constructor") and [Assembler](/wiki/Assembler "Assembler")
    * [Miners](/wiki/Miner "Miner") and [Oil Pumps](/wiki/Oil_Pump "Oil Pump")
    * A few others
  * Adjusted the cost of the [Programmable](/wiki/Programmable_Splitter "Programmable Splitter") and [Smart Splitter](/wiki/Smart_Splitter "Smart Splitter")
  * Adjusted the cost of Caterium Milestones 2 and 3
  * Added [Alien Organs](/wiki/Alien_Organ "Alien Organ") research after Alien Carapace (making it possible to turn Alien Organs into [Medicinal Inhalers](/wiki/Medicinal_Inhaler "Medicinal Inhaler"))
  * Adjusted the cost of making Medicinal Inhalers (more [Mycelia](/wiki/Mycelia "Mycelia"), less [Nuts](/wiki/Beryl_Nut "Beryl Nut"))
  * Greatly increased the amount of parts around [Crash Sites](/wiki/Wreckage "Wreckage") for new games
  * Reduced [Caterium Ore](/wiki/Caterium_Ore "Caterium Ore") required to make [Caterium Ingots](/wiki/Caterium_Ingot "Caterium Ingot") from 4 to 3
  * Reduced the [Quickwire](/wiki/Quickwire "Quickwire") cost of Quickwire alternate recipes
  * Increased [Power Pole](/wiki/Power_Pole "Power Pole") Mk.2 & 3 connections by 1 and 2 respectively
  * Increased the parts cost of some Buildings and Equipment 
    * Generators: [Fuel Generator](/wiki/Fuel_Generator "Fuel Generator"), [Geothermal Generator](/wiki/Geo_Thermal_Generator "Geo Thermal Generator")
    * Production Buildings: [Manufacturer](/wiki/Manufacturer "Manufacturer"), [Miner Mk.2](/wiki/Miner_Mk.2 "Miner Mk.2"), [Oil Pump](/wiki/Oil_Pump "Oil Pump"), [Oil Refinery](/wiki/Oil_Refinery "Oil Refinery")
    * Equipment: [Xeno Basher](/wiki/Xeno-Basher "Xeno-Basher"), [Jetpack](/wiki/Jetpack "Jetpack"), [Gas Mask](/wiki/Gas_Mask "Gas Mask")
  * Tweaked the [Rebar Gun](/wiki/Rebar_Gun "Rebar Gun") damage
  * Increased the duration that a Gas Mask [Filter](/wiki/Filter "Filter") lasts
  * [Beacons](/wiki/Beacon "Beacon") can now be built in the Manufacturer
  * [Power Shards](/wiki/Power_Shard "Power Shard") can no longer be used as fuel



## Bug fixes

  * Fixed rounding of [power](/wiki/Power "Power") numbers
  ...
  * Fixed [the Hub](/wiki/The_HUB "The HUB") upgrade effect to be visible for both client and server
...
## Quality of Life
  ...
  * [Hub parts](/wiki/HUB_Parts "HUB Parts") are now returned to the player on respawn or passed to other players if possible when their death [crate](/wiki/Crate "Crate") is spawned
  ...
  * Connecting [Conveyor Belts](/wiki/Conveyor_Belts "Conveyor Belts") with conflicting directions is no longer possible
...
## Factory
  ...
  * Added power connections to the Hub [Biomass Burners](/wiki/Biomass_Burner "Biomass Burner")
...
## Vehicles
  ...
  * Updated the [Truck](/wiki/Truck "Truck") description
...
## Resources
  ...
  * Added a new [Cable](/wiki/Cable "Cable") mesh and texture
...
## World
  ...
  * Adjusted and fixed gameplay and Resource Nodes in several locations 
    * Northern Forest [Limestone](/wiki/Limestone "Limestone") location
  ...
  * Made the Yellow [Power Slug](/wiki/Power_Slug "Power Slug") more... yellow.



## Wildlife

  * [Hogs](/wiki/Hog "Hog") now have a cooldown on their stagger
  * Made the [Alpha Hog](/wiki/Alpha_Hog "Alpha Hog") more aggressive
  * Made a small fix to the Hog panic state
  * [Stingers](/wiki/Stinger "Stinger") (spider-like creature) now drop Alien Organs
  * Added LODs for the Stinger
  * Expanded the amount of resources [Lizard Doggo](/wiki/Lizard_Doggo "Lizard Doggo") can find
  * Added new sounds to the [Space Giraffe/Tick/Whale/Penguin](/wiki/Space_Giraffe-Tick-Penguin-Whale_Thing "Space Giraffe-Tick-Penguin-Whale Thing")
...
[](/wiki/File:Update1_KeyArt.png)

[](/wiki/File:Update1_KeyArt.png "Enlarge")
...
Experimental Update 1| 0.1.5 • [0.1.6 (98394)](/wiki/Patch_0.1.6_build_98394 "Patch 0.1.6 build 98394") • [0.1.6 (98445)](/wiki/Patch_0.1.6_build_98445 "Patch 0.1.6 build 98445") • [0.1.7](/wiki/Patch_0.1.7 "Patch 0.1.7") • [0.1.8](/wiki/Patch_0.1.8 "Patch 0.1.8") • [0.1.9](/wiki/Patch_0.1.9 "Patch 0.1.9") • [0.1.10](/wiki/Patch_0.1.10 "Patch 0.1.10")  
