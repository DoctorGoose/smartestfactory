...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.8.2.2** – Build 260656. This patch was released on 20 October 2023.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1164858181130924094), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/17c74v5), and [Steam](https://store.steampowered.com/news/app/526870/view/3713839713514643872). 
...
## QoL
  ...
  * [Signs](/wiki/Signs "Signs")
    * Removed restrictions for snapping Signs to [pillars](/wiki/Pillars "Pillars"), they can now snap to any side at any time
    * When snapping a Sign to a [Foundation](/wiki/Foundation "Foundation"), ceiling or floor, you can now hold [`Ctrl`](/wiki/Controls "Controls") to lay the sign down flat, otherwise it will use the pole support
  * [Dismantling](/wiki/Build_Gun "Build Gun")
...
## Bug fixes
  ...
  * Fixed the [Object Scanner](/wiki/Object_Scanner "Object Scanner") displaying incorrectly when using an [Field of View (FOV)](/wiki/Settings#Camera_2 "Settings") other than 90
  * Fixed the [Railroad Tracks](/wiki/Railway "Railway") displaying incorrectly
  * Fixed broken sign rotation for [Beams](/wiki/Beams "Beams")
  * Fixed an issue where certain buildings would not rotate correctly when snapping to Foundation sides and ceilings
  * Fixed bug where [conveyor lifts](/wiki/Conveyor_Lifts "Conveyor Lifts") were able to snap to connections which are not aligned with its input or output
  * Changed the default [keybinding](/wiki/Settings#Keybindings "Settings") for Saving Hologram to Hotbar to be unbound/empty 
    * This means that if you want to use it, you will have to manually bind it to a key, but for now it has been defaulted to nothing as it has been causing issues related to the [`Alt`](/wiki/Controls "Controls") key getting stuck
