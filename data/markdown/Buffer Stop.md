...
[ ](/wiki/File:Buffer_Stop.png "Buffer Stop.png")

_Prevents trains from derailing at the end of a railway.  
While automated driving systems have made Buffer Stops mostly obsolete, their use is still recommended to mitigate potential human error._
...
**20 ×[](/wiki/Concrete "Concrete") [Concrete](/wiki/Concrete "Concrete")**

The **Buffer Stop** is a [Railway](/wiki/Railway "Railway") attachment unlocked in [Tier 6](/wiki/Tier_6 "Tier 6") that is used to prevent manually-driven [Electric Locomotives](/wiki/Electric_Locomotive "Electric Locomotive") from derailing by reaching the end of the railway. 

It has no use for automated Electric Locomotives. 

## Usage

Buffer Stops can be directly snapped to an end of an existing Railway, or vice versa. Upon collision, the [Electric Locomotive](/wiki/Electric_Locomotive "Electric Locomotive") will lose all of its speed, and a camera shake effect will be applied on impact.[1]

Despite seeming like high speeds could cause problems, the Electric Locomotive's [Freight Cars](/wiki/Freight_Car "Freight Car") will not derail from high speed collisions. 

## History

  * [Patch 1.1.0.2](/wiki/Patch_1.1.0.2 "Patch 1.1.0.2"): Fixed snapping issue when snapping a [Railway](/wiki/Railway "Railway") to a Buffer Stop
  * [Patch 1.1.0.0](/wiki/Patch_1.1.0.0 "Patch 1.1.0.0")
    * Introduced 
      * We're introducing a new mechanic for trains, when manually driving a [Train](/wiki/Train "Train") and reaching the end of the railway, Trains will now derail entirely and you will have to interact with the train in order to get it back on the rail, similar to how Train Collisions work.
...
## References
  ...
  1. ↑ [YouTube - What's in 1.1? - Buffer Stops](https://www.youtube.com/watch?v=Ty7GdZvCETo&t=472s)
