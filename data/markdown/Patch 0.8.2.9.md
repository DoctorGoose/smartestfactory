...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.8.2.9** – Build 264901. This patch was released on 9 November 2023.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1172272016162836531), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/17rm7fu), and [Steam](https://store.steampowered.com/news/app/526870/view/3809543111540472139). 
...
Hello again everyone, Here’s another patch with a variety of fixes and improvements such as fixing another legacy issue where targeting [Electric Locomotives](/wiki/Electric_Locomotive "Electric Locomotive")/[Freight Carts](/wiki/Freight_Car "Freight Car") inside a [Train Station](/wiki/Train_Station "Train Station") was more difficult than it should be, [Jetpack](/wiki/Jetpack "Jetpack") fuel selection not working correctly, Improvements with hitching/stuttering around [Refineries](/wiki/Refinery "Refinery")/[Blenders](/wiki/Blender "Blender")/[Pipes](/wiki/Pipe "Pipe") fixing and more! 
...
## EOS
  ...
  * Added a popup to inform when an [online session could not be created](/wiki/Game_menus#Offline_warning "Game menus") and that you are about to continue offline 
...
## Bug fixes
  ...
  * Fixed incorrect text when mining [resource nodes](/wiki/Resource_node "Resource node")
  * Fixed [conveyor belts](/wiki/Conveyor_Belts "Conveyor Belts") being able to be built in invalid shapes by using Nudge
  * Fixed a bug where [Packaged Liquid Biofuel](/wiki/Packaged_Liquid_Biofuel "Packaged Liquid Biofuel") could not be selected in the [Jetpack](/wiki/Jetpack "Jetpack") until [Packaged Turbofuel](/wiki/Packaged_Turbofuel "Packaged Turbofuel") is unlocked
  * You can now more easily interact with [Electric Locomotives](/wiki/Electric_Locomotive "Electric Locomotive") and [Freight Carts](/wiki/Freight_Car "Freight Car") when they are docked on a [Train Station](/wiki/Train_Station "Train Station")
  * Fixed [Graphics Preset](/wiki/Settings#General_2 "Settings") option always showing “Custom” on some hardware configurations that did not support some of the options
  * Some improvements to [Pipe](/wiki/Pipelines "Pipelines") SFX causing hitches/stuttering in factories with a lot of [Refineries](/wiki/Refinery "Refinery")/[Blenders](/wiki/Blender "Blender") built
