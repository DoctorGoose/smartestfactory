...
Patch Notes: **v1.0.0.1** – Build 366202. This patch was released on 12 September 2024.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1283822451918377091), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/1ff6c45), and [Steam](https://store.steampowered.com/news/app/526870/view/4615715344788357373). 
...
## Bug fixes
  ...
  * Fixed an issue where [Coal Generators](/wiki/Coal_Generator "Coal Generator") would stop working after interacting with them in some scenarios
  * Fixed a crash when [chainsawing](/wiki/Chainsaw "Chainsaw") certain foliage
  * Please note that some foliage cannot be removed with the chainsaw currently, but it is removable by the [Nobelisk](/wiki/Nobelisk "Nobelisk")
  * Removed the remaining functionality to take high-res screenshots while using [Photo Mode](/wiki/Photo_Mode "Photo Mode") since it was previously broken and causing crashes
...
## UI
  ...
  * Added a new tooltip on the [Language](/wiki/Settings#Language "Settings") selection menu 
...
## Dedicated servers
  ...
  * Fix for [Dedicated Server](/wiki/Dedicated_Server "Dedicated Server") Manager/HTTP API not binding to the correct bind address when there is only one network adapter in the system or multihome active, resulting in Server Manager not working.
...
[Crash] Shader Cache (workaround available)
    ...
    Video of how to set dx11 as a launch option: [https://www.youtube.com/watch?v=cn3e-m4a-hU&t=438s](https://www.youtube.com/watch?v=cn3e-m4a-hU&t=438s)
    Text information on how to set launch options: <https://www.pcgamingwiki.com/wiki/Glossary:Command_line_argument>
    See also [Launch arguments](/wiki/Launch_arguments "Launch arguments")
