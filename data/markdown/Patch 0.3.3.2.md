...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.3.3.2** – Build 116997. This patch was released on 10 March 2020.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/686950693461819460) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/fgf1yl). 
...
## Factory
  ...
  * New icons for changed resources: 
    * [AI Limiter](/wiki/A.I._Limiter "A.I. Limiter"), [Crystal Oscillator](/wiki/Crystal_Oscillator "Crystal Oscillator"), [Circuit Board](/wiki/Circuit_Board "Circuit Board"), [Fuel](/wiki/Fuel "Fuel"), [Hard Drive](/wiki/Hard_Drive "Hard Drive"), [Hazmat Filter](/wiki/Iodine_Infused_Filter "Iodine Infused Filter"), [Hazmat Suit](/wiki/Hazmat_Suit "Hazmat Suit"), [Liquid Biofuel](/wiki/Liquid_Biofuel "Liquid Biofuel"), [Crude Oil](/wiki/Crude_Oil "Crude Oil"), [Heavy Oil Residue](/wiki/Heavy_Oil_Residue "Heavy Oil Residue"), [Quickwire](/wiki/Quickwire "Quickwire"), [Silica](/wiki/Silica "Silica"), [Wire](/wiki/Wire "Wire"), [Turbofuel](/wiki/Turbofuel "Turbofuel")
  * New icon for [Stackable Hyper Tube Support](/wiki/Stackable_Hyper_Tube_Support "Stackable Hyper Tube Support")
  * New icon for [Personal Storage Box](/wiki/Personal_Storage_Box "Personal Storage Box")



## World

  * Fixed some holes in the world in a cave and on top of a waterfall in the [Dune Desert](/wiki/Map "Map")
  * [Bauxite](/wiki/Bauxite "Bauxite") Resource Nodes now have their own textures
  * Put [geyser](/wiki/Geyser "Geyser") meshes in the world to their actual size (they were smaller than intended before)
  * Removed some [geyser](/wiki/Geyser "Geyser") meshes that were not supposed to be there
