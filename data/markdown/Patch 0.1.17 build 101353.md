...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.1.17** – Build 101353. This patch was released on 27 June 2019.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/593844936055455744) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/c67w9q). 

The version number, v0.1.17, wasn't incremented, meaning it is used for two successive patches. The following patch is [v0.1.19](/wiki/Patch_0.1.19 "Patch 0.1.19"), skipping v0.1.18. 
...
A few hours after the patch's release, a hotfix was released. It incremented the build number to 101376. 

    Hi Pioneers!
    Hotfix incoming for a crash that happened when you loaded some games. It will no longer crash as long as you play Single Player, but will probably crash if someone joins you. Sorry for the bother! We gathered a bit too much info trying to find another crash...

## Intro

Hi Pioneers! 

Third time’s the charm! We’re really glad you help us out with finding more issues that we want to fix before releasing this to stable. Our main focus is to fix the trains but we’ve also added more information to some crashes so we hopefully can get some of them fixed sooner rather than later. 

## Trains

  * Updates to some sounds
  * Power graph fixed in [Train Station](/wiki/Train_Station "Train Station")
  * Added docking notification while driving a train
  * You can dismantle the Freight Platform again
  * Shift-click support for the [Freight Platform](/wiki/Freight_Platform "Freight Platform") inventory
  * Freight Platform now stops if power outage occurs, and resumes when powered up again
  * Train AI no longer gets stuck when [railroad](/wiki/Railway "Railway") is removed ahead
...
## Factory
  ...
  * [8x1 m Foundations](/wiki/Foundation_8m_x_1m "Foundation 8m x 1m") now available to allow for foundations matching the height of Train Stations
