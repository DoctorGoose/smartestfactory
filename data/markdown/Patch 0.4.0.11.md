...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.4.0.11** – Build 150010. This patch was released on 9 April 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/830173230383497266), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/mnpmni), and [Steam](https://store.steampowered.com/news/app/526870/view/3110273656379217544). 

## Contents

  * 1 Intro
  * 2 Balancing
    * 2.1 Recipe rebalances
  * 3 Bug fixes
  * 4 Optimisation
  * 5 Known issues
...
## Balancing
  ...
  * Moved [Hover Pack](/wiki/Hover_Pack "Hover Pack") to early Tier 7 and replaced [Cooling System](/wiki/Cooling_System "Cooling System") and [Radio Control Unit](/wiki/Radio_Control_Unit "Radio Control Unit") by [Heavy Modular Frame](/wiki/Heavy_Modular_Frame "Heavy Modular Frame") and [Computer](/wiki/Computer "Computer") in its recipe.
  * [Jetpack](/wiki/Jetpack "Jetpack") no longer requires Computers for its unlock, making it a bit easier to unlock in early Tier 6.
  * Rebalanced [Plutonium](/wiki/Plutonium_Pellet "Plutonium Pellet") production
  * Generally reduced [Nitrogen](/wiki/Nitrogen_Gas "Nitrogen Gas") usage and reduced [Bauxite](/wiki/Bauxite "Bauxite") and [Sulfur](/wiki/Sulfur "Sulfur") usage on some alts.
  * Updated [radiation](/wiki/Radiation "Radiation") levels to fit new item production rates.
  * Updated [Sink](/wiki/Sink "Sink") point values for items affected by recent balance changes.
  * Reduced default round-trip [Battery](/wiki/Battery "Battery") cost for [Drones](/wiki/Drone "Drone") to 4 (from 5) and reduced cost/distance from 1.66 to 1 Battery per kilometre.



### Recipe rebalances

  * [Non-fissile Uranium](/wiki/Non-fissile_Uranium "Non-fissile Uranium"): Halved [Nitric Acid](/wiki/Nitric_Acid "Nitric Acid") input (Nitrogen usage reduced by 50%)
  * [Fertile Uranium](/wiki/Non-fissile_Uranium "Non-fissile Uranium"): Reduced Nitric Acid usage from 40 to 15 per minute (Nitrogen usage reduced by 62.5%) and reduced [Sulfuric Acid](/wiki/Sulfuric_Acid "Sulfuric Acid") usage from 40 to 25 per minute.
  * [Instant Plutonium Cell](/wiki/Encased_Plutonium_Cell "Encased Plutonium Cell"): No longer uses Nitrogen, reduced [Aluminum Casing](/wiki/Aluminum_Casing "Aluminum Casing") from 25 to 10 per minute.
  * Halved [Uranium Waste](/wiki/Uranium_Waste "Uranium Waste") output (From 20 to 10 per minute)
  * Halved Uranium Waste usage on all relevant recipes, so ratios remain the same: 
    ...
    * [Plutonium Pellet](/wiki/Plutonium_Pellet "Plutonium Pellet"): 50 to 25 per min
...
## Bug fixes
  ...
  * Reverted the fix: “Fixed a bug that prevented [Miners](/wiki/Miner "Miner") from being upgraded/downgraded” as it erroneously allowed extractors to be upgraded into other Extractors. (Read more in the “Known Issues” section at the bottom)
...
## Optimisation
  ...
  * Fixed more [conveyor belt](/wiki/Conveyor_Belt "Conveyor Belt") items.
