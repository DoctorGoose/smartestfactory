...
[](/wiki/File:Icon-move.png) | It has been _**suggested**_ that this article or section be **moved to[Patch 0.1.17 build 101256](/wiki/Patch_0.1.17_build_101256?action=edit&redlink=1 "Patch 0.1.17 build 101256 \(page does not exist\)").**  
  
  * Reason: Consistent naming scheme
  * Please discuss this on the [Discussion page](/wiki/Talk:Patch_0.1.17?action=edit&redlink=1 "Talk:Patch 0.1.17 \(page does not exist\)").
...
It has been _**suggested**_ that this article or section be **moved to[Patch 0.1.17 build 101256](/wiki/Patch_0.1.17_build_101256?action=edit&redlink=1 "Patch 0.1.17 build 101256 \(page does not exist\)").**  
...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.1.17** – Build 101256. This patch was released on 26 June 2019. 

The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/593448045610532938) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/c5qjhj). 
...
It’s a smaller update this time with fixes for what seems to be the most annoying issues. And a couple of crash fixes. Enjoy with caution, since it’s still very experimental! 

## Trains

  * Freight station in the middle of animation work so it’s supposed to look like that atm
  * Trains should no longer get stuck if they don’t have any valid [Freight Platforms](/wiki/Freight_Platform "Freight Platform")
...
## Factory
  ...
  * [Nuclear Power Plant](/wiki/Nuclear_Power_Plant "Nuclear Power Plant") no longer encroaches [Foundations](/wiki/Foundations "Foundations")
