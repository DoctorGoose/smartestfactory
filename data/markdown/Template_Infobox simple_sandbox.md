# Template:Infobox simple/sandbox

[](/wiki/File:Template-info.svg) Documentation

[[purge](https://satisfactory.wiki.gg/wiki/Template:Infobox_simple/sandbox?action=purge)]
...
The above documentation is transcluded from [Template:Infobox simple/sandbox/doc](/wiki/Template:Infobox_simple/sandbox/doc "Template:Infobox simple/sandbox/doc"). ([edit](https://satisfactory.wiki.gg/wiki/Template:Infobox_simple/sandbox/doc?action=edit) | [history](https://satisfactory.wiki.gg/wiki/Template:Infobox_simple/sandbox/doc?action=history))
