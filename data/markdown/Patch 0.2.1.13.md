...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.2.1.13** – Build 105818. This patch was released on 25 September 2019.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/626464142382858271) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/d967fk). 
...
## Other bug fixes
  ...
  * Fixed issue with [biomass burner](/wiki/Biomass_Burner "Biomass Burner") not rendering at times
  * Client side issue with inventory not updating for miners
  * Fixed issue with [Splitters](/wiki/Conveyor_Splitter "Conveyor Splitter")/[Mergers](/wiki/Conveyor_Merger "Conveyor Merger") not snapping properly to foundations when using guidelines
