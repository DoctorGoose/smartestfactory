...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.3.4.7** – Build 121119. This patch was released on 4 May 2020.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/706909568843644979) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/gdf30s). 
...
Also, when loading a save while playing, the game currently creates an offline session. That means that no other players will be able to join. To prevent that, load the save from the main menu instead. 
...
## UI
  ...
  * Default keybindings for cycling through the Hotbars is now Alt + mouse wheel up and down



## Resources

  * New [Conveyor Belt](/wiki/Conveyor_Belt "Conveyor Belt") meshes & icons for raw resources: 
    * [Limestone](/wiki/Limestone "Limestone"), [Iron Ore](/wiki/Iron_Ore "Iron Ore"), [Copper Ore](/wiki/Copper_Ore "Copper Ore"), [Caterium Ore](/wiki/Caterium_Ore "Caterium Ore"), [Raw Quartz](/wiki/Raw_Quartz "Raw Quartz"), [Uranium Ore](/wiki/Uranium "Uranium"), [Bauxite](/wiki/Bauxite "Bauxite"), [Sulfur](/wiki/Sulfur "Sulfur")



## Bug fixes

  * Fixed a crash that occurred when clients joined a game (related to [track](/wiki/Track "Track") connection)
  * Fixed client crashing when the host builds railroad tracks
  * Right click now closes the build menu again
  * Moving the cursor away from a building while dismantling no longer stops the dismantle action
  * Shift clicking/Ctrl Clicking items into [vehicle](/wiki/Vehicles "Vehicles") storages no longer replaces things already in the fuel slot
