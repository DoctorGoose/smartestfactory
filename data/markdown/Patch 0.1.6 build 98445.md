# Patch 0.1.6 build 98445

Patch Notes: Early Access (EXPERIMENTAL) – **v0.1.6** – Build 98445. This patch was released on 6 May 2019. It is a re-release of a patch with the same version number, build 98394.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/574976184442421278) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/blde90). 
...
Here we go, the actual patch to bring you several crash fixes, bug fixes, balancing changes and a few content additions. This time without removing all the logistics items. 

Hope you all enjoy the patch! 

## Balancing

  * Doubled the cost of the [Conveyor Lifts](/wiki/Conveyor_Lift "Conveyor Lift")
...
## Bug fixes
  ...
  * Fixed the outdated [Power Pole](/wiki/Power_Pole "Power Pole") descriptions
  * Fixed custom names for the [Radio Tower](/wiki/Radio_Tower "Radio Tower") disappearing after reloading a save
  * Fixed that firing the [Rebar Gun](/wiki/Rebar_Gun "Rebar Gun") at a [Flying Crab](/wiki/Flying_Crab "Flying Crab") crashes the game
  * Fixed the missing texture for [Sulphur](/wiki/Sulfur "Sulfur") on Conveyor Belts
  * Fixed the [Portable Miner](/wiki/Portable_Miner "Portable Miner") duplication bug
  * Fixed that inputting more than 1 [Power Shard](/wiki/Power_Shard "Power Shard") into an Overclocking slot doesn’t consume the rest of the stack
...
## Factory
  ...
  * Updated the visuals of [Splitters](/wiki/Splitter "Splitter") & [Merger](/wiki/Merger "Merger")



## Equipment

  * Improved [Nobelisk Detonator](/wiki/Nobelisk_Detonator "Nobelisk Detonator") sounds



## Optimisation

  * Fixed an issue with the [Destructible Rocks](/wiki/Cracked_boulder "Cracked boulder") that impacted performance



## Narrative

  * Implemented [Map](/wiki/Map "Map") and Radar Tower emails



## World

  * Redesigned the southern part of the [Dune Desert](/wiki/Dune_Desert "Dune Desert")
...
Experimental Update 1| [0.1.5](/wiki/Patch_0.1.5 "Patch 0.1.5") • [0.1.6 (98394)](/wiki/Patch_0.1.6_build_98394 "Patch 0.1.6 build 98394") • 0.1.6 (98445) • [0.1.7](/wiki/Patch_0.1.7 "Patch 0.1.7") • [0.1.8](/wiki/Patch_0.1.8 "Patch 0.1.8") • [0.1.9](/wiki/Patch_0.1.9 "Patch 0.1.9") • [0.1.10](/wiki/Patch_0.1.10 "Patch 0.1.10")  
