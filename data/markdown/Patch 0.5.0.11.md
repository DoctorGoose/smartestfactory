...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.5.0.11** – Build 173131. This patch was released on 17 November 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/910621062675447868), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/qw7nx8), and [Steam](https://store.steampowered.com/news/app/526870/view/3136189647406732016). 
...
## New
  ...
  * Added [Block/Path Signal](/wiki/Train_Signals "Train Signals") visual feedback when placing down
  * Hyper Tube Floor Holes are now available in the [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop")



## Bug fixes

  * Fixed some [FICSIT Factory Swatches](/wiki/Customizer "Customizer") being wrongly applied to some [foundation](/wiki/Foundation "Foundation") types after last update
  * Fixed a crash related to [Vehicle](/wiki/Vehicle "Vehicle") Automation
  ...
  * Foundations should now only rotate 90ºs when aligning to [World Grid](/wiki/Foundations#World_grid "Foundations")



## UI

  * News feed ([Main Menu](/wiki/Game_menus#Main_menu "Game menus")) background is now darker and semi transparent for better readability
