# Patch 0.2.1.7 (Experimental)

Patch Notes: Early Access (EXPERIMENTAL) – **v0.2.1.7** – Build 102599. This patch was released on 29 July 2019.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/605428344699355139) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/cjd4qn). 
...
## Optimisation
  ...
  * Added an option to toggle the different culling system (Hierarchical Z-Buffer Occlusion). If the last update introduced a performance drop, it might be worthwhile to switch back to the previous method.



## Localisation

  * Added Greek, Finnish and Dutch
