...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.8.0.3** – Build 239478. This patch was released on 19 June 2023.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1120424839409303653), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/14dmxoj), and [Steam](https://store.steampowered.com/news/app/526870/view/6027552699447950502). 
...
## Bug fixes
  ...
  * Fixed the [Railways](/wiki/Railway "Railway"), [Hypertubes](/wiki/Hypertube "Hypertube") and [Pipelines](/wiki/Pipelines "Pipelines") visually having incorrect rotation when set via [Blueprint](/wiki/Blueprint "Blueprint")
    * This may also fix sinking/incorrectly rotated foundations in some scenarios
  * Fixed the [parachute](/wiki/Parachute "Parachute") visuals on [conveyor belts](/wiki/Conveyor_Belt "Conveyor Belt") or when dropped
  * Fixed the camera for the [Factory Cart](/wiki/Factory_Cart "Factory Cart"), it was incorrectly set so it would clip drastically when indoors
...
## World
  ...
  * A few parts near the coastline of [Rocky Desert](/wiki/Rocky_Desert "Rocky Desert") are now more complete in terms of foliage and world design
  * Fixed some issues with the [Gas Pillar](/wiki/Gas_Pillar "Gas Pillar") effects in a few areas of Dune Desert and Spire Coast, also fixed some locations in Titan Forest leading towards Desert Canyon
...
## Gameplay
  ...
  * Removed the option to purchase Parachutes from the [Awesome Shop](/wiki/AWESOME_Shop "AWESOME Shop") now that it is no longer a consumable item
  * Toned down the new parachute recipe
  * Minor updates to the descriptions of the Jetpack and Fuels to match the new [Jetpack](/wiki/Jetpack "Jetpack") changes
  * Fixed the wording for the [Priority Power Switch](/wiki/Priority_Power_Switch "Priority Power Switch") description to match the UI
  * Fixed the FICSIT Blueprints [milestone](/wiki/Milestone "Milestone") not showing the [Blueprint Designer](/wiki/Blueprint_Designer "Blueprint Designer") in the unlock list
