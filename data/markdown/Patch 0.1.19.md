...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.1.19** – Build 101486. This patch was released on 28 June 2019. 

The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/594237571438084127) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/c6o1ae). 
...
I hope you’re not getting tired of updating the game, because we have another one incoming before the weekend. Enjoy the weekend with updated visuals for trains and stations! 

## Trains

  * Updated visuals to [Train Station](/wiki/Train_Station "Train Station") including showing Station Name
  * [Freight Platform](/wiki/Freight_Platform "Freight Platform") updated animations and visuals
  * Changed input/ouputs of Freight Platforms
  * [Freight Cart](/wiki/Freight_Car "Freight Car") visual update
  * Power warnings for Trains and Stations
  * Legs added to Station and Platforms
  * Client can now kind of drive [Locomotives](/wiki/Electric_Locomotive "Electric Locomotive")
  * Boogie rotations fixed for clients



## Factory

  * [Hazmat Suit](/wiki/Hazmat_Suit "Hazmat Suit") mesh added
  * [Conveyor Belts](/wiki/Conveyor_Belts "Conveyor Belts") MK 4 & 5 texture upgrade
  * More work done on [Nuclear Power Plant](/wiki/Nuclear_Power_Plant "Nuclear Power Plant")
...
## Bugs
  ...
  * Fixed sound bugs
  * Dismantling of Freight Cars is fixed​



## World

  * Various optimizations and collision fixes for trees and bushes
