...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.1.14** – Build 100692. This patch was released on 14 June 2019. It is the first patch of Update 2 development.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/589122081971503159) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/c0ls4d). 
...
First of all, this update to the experimental branch is a DANGEROUS one. It’s the most “experimental” build we’ve put out until now, so there will likely be new crashes and bugs. You might have to restart the game after some crashes when playing multiplayer. I’d like to remind you to back up your save files before trying it out. You can find your [Save files](/wiki/Save_files "Save files") here: 
...
## New content
  ...
  * [Tier 7](/wiki/Milestones "Milestones") (Overall still work in progress)
  * Nuclear Power.
  * Take your power production to the next level with [Nuclear Power Plants](/wiki/Nuclear_Power_Plant "Nuclear Power Plant"), but be wary of the [radiation](/wiki/Uranium#Radiation "Uranium")! You’ll have to deal with the [Nuclear Waste](/wiki/Nuclear_Waste "Nuclear Waste") you are producing.
  * This includes a [Hazmat Suit](/wiki/Hazmat_Suit "Hazmat Suit") to keep yourself safe from radiation.
  * Bayer Process. 
    * Now it is time to integrate [Bauxite](/wiki/Bauxite "Bauxite") into your production pipelines and set up the production of several new parts.
    * You’ll also be able to try out the next step in quickly extracting resources with the [Miner Mk.3](/wiki/Miner_Mk.3 "Miner Mk.3") and the [Conveyor Belt](/wiki/Conveyor_Belt "Conveyor Belt") Mk.5
...
## Balancing
  ...
  * Doubled [Circuit Board](/wiki/Circuit_Board "Circuit Board") stack size
  * Tweaked resources in several areas 
    * Red Jungle (Plateau northwest of Grass Fields) 
      * Added [Bauxite](/wiki/Bauxite "Bauxite"), [Uranium](/wiki/Uranium "Uranium") and [Coal](/wiki/Coal "Coal")
...
## Bug fixes
  ...
  * Fixed an on load crash related to the Small [Stinger](/wiki/Stinger "Stinger")
  * Fixed crashes related to [Arachnophobia Mode](/wiki/Arachnophobia_Mode "Arachnophobia Mode")
  ...
  * [Alien Armour Plates](/wiki/Alien_Carapace "Alien Carapace") dropped by the [Flying Crab Hatcher](/wiki/Flying_Crab_Hatcher "Flying Crab Hatcher") are now visible for client
  * Fixed the [MAM](/wiki/MAM "MAM") getting locked on ongoing research if the time was corrupt
  * [Conveyor Pole](/wiki/Conveyor_Pole "Conveyor Pole") holograms now show properly under the Conveyor Belt for client
