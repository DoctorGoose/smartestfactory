...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.7.0.4** – Build 209551. This patch was released on 24 November 2022.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1045475136150700032), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/z3xcur), and [Steam](https://store.steampowered.com/news/app/526870/view/3485252139457254781). 
...
## Bug fixes
  ...
  * Fixed invisible buildings built from [Blueprints](/wiki/Blueprint "Blueprint") when reconnecting to [Dedicated Servers](/wiki/Dedicated_Servers "Dedicated Servers")
  * Fixed items getting stuck on [conveyor belts](/wiki/Conveyor_Belt "Conveyor Belt") in [multiplayer](/wiki/Multiplayer "Multiplayer")
  * Potential fix for [Smart Splitter](/wiki/Smart_Splitter "Smart Splitter") overflow issues
  * Fixed [Zipline](/wiki/Zipline "Zipline") sprinting not working for Clients
