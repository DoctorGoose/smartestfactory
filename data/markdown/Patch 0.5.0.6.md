...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.5.0.6** – Build 171407. This patch was released on 3 November 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/905571213068345344), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/qm4xlw), and [Steam](https://store.steampowered.com/news/app/526870/view/3095655981376591838). 
...
## Bug fixes
  ...
  * Fixed [Inventory](/wiki/Inventory "Inventory") slot abbreviated item text breaking the layout if the text was too long
  * Fixed [Milestone Progression UI](/wiki/HUD#Milestone_requirement "HUD") not being visible anymore
  * [Conveyor Lifts](/wiki/Conveyor_Lifts "Conveyor Lifts") and both [Conveyor](/wiki/Conveyor_Poles "Conveyor Poles") / [Pipeline](/wiki/Pipeline_Supports "Pipeline Supports") Floor Holes should now properly have soft clearance
  * Potentially fixed a crash when [mass dismantling](/wiki/Build_Gun#Mass_dismantle "Build Gun")
  * Potentially fixed a crash related to using the [Rebar Gun](/wiki/Rebar_Gun "Rebar Gun") on [Dedicated Server](/wiki/Dedicated_Server "Dedicated Server")
  * Fixed SFX missing for crafting on the [Craft Bench](/wiki/Craft_Bench "Craft Bench") and in the [Equipment Workshop](/wiki/Equipment_Workshop "Equipment Workshop").
  * Fixed an issue where the cursor would jump to the end when typing in the middle of a [Signs](/wiki/Signs "Signs") textbox
  * Re-added 2 missing [Crash Sites](/wiki/Crash_Site "Crash Site")
  * Potential fixes for some [Pipeline](/wiki/Pipeline "Pipeline") snapping issues
  * Potential fix for a Floor Hole related crash
  * Fixed [Chainsaw](/wiki/Chainsaw "Chainsaw") custom [volume settings](/wiki/Settings#Audio "Settings") not working properly
  * Fixed [Vehicle](/wiki/Vehicle "Vehicle") physics not working as intended on [Foundations](/wiki/Foundations "Foundations")
  * Potential fix for Signs being reset when rejoining a game
  * Fixed background images used as icons on Signs being stretched
  * Fixed Hologram snapping always using automatic clearance snapping if a [Multiplayer](/wiki/Multiplayer "Multiplayer") / [Dedicated Server](/wiki/Dedicated_Server "Dedicated Server") Client was [building](/wiki/Build_Gun "Build Gun"), it now updates settings between Client and Host/Server
  * Fixed [Customizer](/wiki/Customizer "Customizer") shortcuts being wiped from Hotbars in offline saves
  * Potential fix for rare crash on join in [Multiplayer](/wiki/Multiplayer "Multiplayer")
  * Fixed [Nobelisk](/wiki/Nobelisk "Nobelisk")/[Snowballs](/wiki/FICSMAS#Parts "FICSMAS") on Dedicated servers
  * Fixed [Miner](/wiki/Miner "Miner") Mk.1 standby switch not working
  * Fixed more issues with clearance snapping
  * Fixed Vehicle icons not rotating on the [Map](/wiki/Map "Map")
  * Fixed some scenarios where [Trains](/wiki/Trains "Trains") waiting at a signal could sometimes have a collision with a Train passing by on a parallel track



## Quality of Life

  * Changed [Ladders](/wiki/Ladder "Ladder") to have soft clearance
  * Added indicator for the HUD in Build Mode to display how many objects are being built when zooping
  * Changed conveyor attachments ([Conveyor Merger](/wiki/Conveyor_Merger "Conveyor Merger"), [Conveyor Splitter](/wiki/Conveyor_Splitter "Conveyor Splitter"), [Smart Splitter](/wiki/Smart_Splitter "Smart Splitter"), and [Programmable Splitter](/wiki/Programmable_Splitter "Programmable Splitter")) to have soft clearance
  * Added the FICSIT Check Mark to the monochrome icons in Signs
  * Improved interaction for [Freight Car](/wiki/Freight_Car "Freight Car") and automatic doors



## Optimisation

  * Adjusted [sky light](/wiki/Unreal_Engine "Unreal Engine")
  * Adjusted clouds
