...
Patch Notes: **v1.1.1.4** – Build 433351. This patch was released on 8 September 2025.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1414635711893606503), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/1nbr17t), and [Steam](https://store.steampowered.com/news/app/526870/view/520849726239672289). 
...
After the initial release on September 8, another post was published as patch notes on September 10, announcing the [anniversary](/wiki/Anniversary "Anniversary") event, originally not listed in the patch notes from September 8. However, no actual patch was released and the build number remained as 433351. 

The original post can be viewed on [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1415321268378538024), [Reddit](https://reddit.com/1nddjgo), and [Steam](https://store.steampowered.com/news/app/526870/view/520849726239672238). 
...
> 
> <https://www.youtube.com/watch?v=eZsxG3h6CqE>
> 
> Thanks community, helps a lot <3 

  * [](/wiki/File:Anniversary_-_Patch_Notes_1.png "Patch Note Image \(Reddit / Discord\)")

Patch Note Image (Reddit / Discord)

  * [](/wiki/File:Anniversary_-_Patch_Notes_2.png "Patch Note Image \(Steam Store\)")

Patch Note Image (Steam Store)
...
## Bug fixes
  ...
  * Fixed [Surround sound](/wiki/Unreal_Engine#Game_audio "Unreal Engine") not working properly since 1.1



## [Dedicated server](/wiki/Dedicated_servers "Dedicated servers")

  * Potential fixes to desync issues by adding a keep alive mechanism to the TCP implementation of Reliable Messaging
...
---  
1.1| [1.1.1.0](/wiki/Patch_1.1.1.0 "Patch 1.1.1.0") • [1.1.1.1](/wiki/Patch_1.1.1.1 "Patch 1.1.1.1") • [1.1.1.2](/wiki/Patch_1.1.1.2 "Patch 1.1.1.2") • [1.1.1.3](/wiki/Patch_1.1.1.3 "Patch 1.1.1.3") • 1.1.1.4  
