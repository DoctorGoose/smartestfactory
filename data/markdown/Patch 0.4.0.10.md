...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.4.0.10** – Build 149702. This patch was released on 8 April 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/829816581219155998), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/mn0vqx), and [Steam](https://store.steampowered.com/news/app/526870/view/3110273656375712352). 
...
## New bugs
  ...
  * [Cheatcrete™](/wiki/Foundations "Foundations") has been unfixed.



## Bug fixes

  * Fixed a bug that prevented [Miners](/wiki/Miner "Miner") from being upgraded/downgraded.
  * Tweaked hologram materials for better visibility
  * Fixed [Aluminum Casing](/wiki/Aluminum_Casing "Aluminum Casing") having the wrong texture in [conveyor belts](/wiki/Conveyor_Belt "Conveyor Belt").
  * Potential fix for the “No error message” crash on Continue/Load.
  * Fixed [Light](/wiki/Light "Light") Quality option resetting every time the game was launched.
  * Fixed bug where the distance between [drone stations](/wiki/Drone_Port "Drone Port") wouldn’t be calculated properly, causing incorrect round-trip time estimates and [battery](/wiki/Battery "Battery") consumption, Battery consumption should now properly increase over larger distances.
