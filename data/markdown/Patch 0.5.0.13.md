...
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/912414919578771497), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/qzslsn), and [Steam](https://store.steampowered.com/news/app/526870/view/3136189647424605430). 
...
## Bug fixes
  ...
  * Fixed an issue where [Vehicles](/wiki/Vehicles "Vehicles") would not receive fuel from a [station](/wiki/Truck_Station "Truck Station") if their fuel inventory was empty
  ...
  * Fixed up LOD bias on [Pillars](/wiki/Pillars "Pillars")
  * Fixed Vehicles burning up fuel when standing still
  * Fixed issue in the main [Foundation](/wiki/Foundations "Foundations")/[Wall](/wiki/Walls "Walls") material that caused secondary colours to affect the primary
  * Fixed a rare crash that affected save edited saves
  * Fixed [Power Lines](/wiki/Power_Line "Power Line") being able to be selected as a [Customizer](/wiki/Customizer "Customizer") target which would then result in them looking weird when a colour swatch was applied
