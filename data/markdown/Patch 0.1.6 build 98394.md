# Patch 0.1.6 build 98394

Patch Notes: Early Access (EXPERIMENTAL) – **v0.1.6** – Build 98394. This patch was released on 3 May 2019. 

The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/573880193924726824) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/bk95cv). 
...
The patch was rolled back less than half an hour after its release due to removing Conveyor Belts from saves. It was properly released on May 6, 2019, with a [build number of 98445](/wiki/Patch_0.1.6_build_98445 "Patch 0.1.6 build 98445"). 

    Due to this patch removing Conveyor Belts from saves, we rolled back to the previous version (Build 98224). Sorry about that! We will be fixing this issue and patching the Experimental Build next week.
    If you have a save that is affected, consider sending me a DM and the save. It will help us with fixing the issue.
    Cheers <3
...
## Balancing
  ...
  * Renamed Gunpowder to [Black Powder](/wiki/Black_Powder "Black Powder")
...
Experimental Update 1| [0.1.5](/wiki/Patch_0.1.5 "Patch 0.1.5") • 0.1.6 (98394) • [0.1.6 (98445)](/wiki/Patch_0.1.6_build_98445 "Patch 0.1.6 build 98445") • [0.1.7](/wiki/Patch_0.1.7 "Patch 0.1.7") • [0.1.8](/wiki/Patch_0.1.8 "Patch 0.1.8") • [0.1.9](/wiki/Patch_0.1.9 "Patch 0.1.9") • [0.1.10](/wiki/Patch_0.1.10 "Patch 0.1.10")  
