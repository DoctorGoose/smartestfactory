...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.7.0.2** – Build 209020. This patch was released on 22 November 2022.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1044757741522137109), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/z28vpg), and [Steam](https://store.steampowered.com/news/app/526870/view/3485252139450079223). 
...
## Bug fixes
  ...
  * Fixed [Tilted Corner walls](/wiki/Walls "Walls") not having soft clearance
  * Fixed some issues when placing buildables at the edge of foundations
  * Fixed [Conveyor ceiling mount](/wiki/Conveyor_Ceiling_Mount "Conveyor Ceiling Mount") not snapping properly
  * Flying [Crab Hatchers](/wiki/Flying_Crab_Hatcher "Flying Crab Hatcher") and [Flying Crabs](/wiki/Flying_Crab "Flying Crab") should now work properly with the hostility settings
  * Fixed wonky Pillar to Pillar snapping
  * Fixed [Pipes](/wiki/Pipeline "Pipeline") and [Conveyor Belts](/wiki/Conveyor_Belts "Conveyor Belts") getting weird split rotations after placing attachments on them
  * Rewrote [Splitter](/wiki/Conveyor_Splitter "Conveyor Splitter")/[Merger](/wiki/Conveyor_Merger "Conveyor Merger") code to make it better
  * Better fix for invalid character names in [Blueprints](/wiki/Blueprint "Blueprint")
  * Fixed items not moving when reaching the end of a Conveyor Belt segment
  * Fixed some scenarios where [Railways](/wiki/Railway "Railway"), Belts and Pipes could be placed through the floor of the [Blueprint Designer](/wiki/Blueprint_Designer "Blueprint Designer")
  * [Vehicles](/wiki/Vehicles "Vehicles") should work again :)
...
## UI
  ...
  * Fixed [Train Station](/wiki/Train_Station "Train Station") map not displaying the zoom in/zoom out slider
  * Fixed [To-Do list](/wiki/To-Do_List "To-Do List") not having a character limit
