...
Patch Notes: Early Access – **v0.3.6.5** – Build 136408. This patch was released on 10 November 2020.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/775775044315512872), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/jrpka8), and [Steam](https://store.steampowered.com/newshub/app/526870/view/2956010149025934882). 
...
In this update the new Packaging building is introduced, which takes over all packaging and unpackaging recipes from the [Refinery](/wiki/Refinery "Refinery") (but no worries, your existing [Refinery](/wiki/Refinery "Refinery") setups will still work). 

We are also adding some serious upgrades for your Pipeline setups with the [Pipeline Mk.2](/wiki/Pipeline_Mk.2 "Pipeline Mk.2"), [Pipeline Pump Mk.2](/wiki/Pipeline_Pump_Mk.2 "Pipeline Pump Mk.2"), and [Valves](/wiki/Valve "Valve") that allow you to limit throughput of a Pipeline. 

There are a bunch more additions, such as a new buildable [Ladder](/wiki/Ladder "Ladder") unlockable in the [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop"), overhauled [Jump Pads](/wiki/Jump_Pad "Jump Pad") to make them much more useful, a new look for the [Refinery](/wiki/Refinery "Refinery"), Serbian (Latin) as a language option, and several quality-of-life improvements. You can find all the details in the patch notes below. 

This version should be largely stable (otherwise it would spend more time on Experimental), but if you do find any new bugs or have feedback for us on the added content, you can go to our QA Site at https://questions.satisfactorygame.com/ and let us know! We are super excited to push this update out to all of you. Hope you are all having a wonderful time and lots of fun with the game <3 

## New content

  * [Packager](/wiki/Packager "Packager")
    * Unlockable in Tier 5, Alternative Fluid Transport
    * New building for packaging and unpackaging recipes
  * [Pipeline Mk.2](/wiki/Pipeline_Mk.2 "Pipeline Mk.2")
    * Unlockable in Tier 6, Pipeline Engineering Mk.2
    * Able to transport 600m³ of [fluids](/wiki/Fluids "Fluids") per minute
  * [Pipeline Pump Mk.2](/wiki/Pipeline_Pump_Mk.2 "Pipeline Pump Mk.2")
    * Unlockable in Tier 6, Pipeline Engineering Mk.2
    * Has a total head lift of 50 meters
  * [Head lift](/wiki/Head_lift "Head lift") feedback 
    * When building Pipeline pumps there is now feedback to help placing them for optimal head lift distribution
  * [Valve](/wiki/Valve "Valve")
    * Unlockable in Tier 5, Oil Processing
    * New attachment that can be used to limit the flow rate of a pipeline
  * [Ladder](/wiki/Ladder "Ladder")
    * Unlockable in the [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop")
    * Their height can be adjusted by dragging the mouse Up/Down before placing
    * Just like the [Wall](/wiki/Wall "Wall") attachments, they also can attach to Walls and under and on the side of [Foundations](/wiki/Foundations "Foundations")
...
## Factory
  ...
  * [Pipeline Pumps](/wiki/Pipeline_Pump "Pipeline Pump") can now be rotated before being placed
  * [Wall attachments](/wiki/Walls#Wall_Attachments "Walls") can now be placed under and on the side of [Foundations](/wiki/Foundations "Foundations") (Power/Pipeline/Hyper Tube Wall attachments)
  * [Jump Pads](/wiki/Jump_Pad "Jump Pad") (Overhaul) 
    ...
    * Removed Old Jump Pads from the Build menu, [Codex](/wiki/Codex "Codex") and Quick Search
  * [Refinery](/wiki/Refinery "Refinery")
    * Updated visuals
...
## Bug fixes
  ...
  * Improved connection mesh for [Power Poles](/wiki/Power_Poles "Power Poles") and [Wall Power Poles](/wiki/Wall_Power_Pole "Wall Power Pole") to always face the player and position better
  * Realigned ladders on some buildings where you could not grab onto them properly when climbing down
  * Fixed the capitalization of coal in the [Resource Scanner](/wiki/Resource_Scanner "Resource Scanner")
...
## Quality of Life
  ...
  * [Build gun](/wiki/Build_Gun "Build Gun") hologram will automatically switch to Wall [Power Poles](/wiki/Power_Poles "Power Poles") when aiming at a Wall or Foundation Side/Bottom when building a cable
  * You cannot put [Power Slugs](/wiki/Power_Slug "Power Slug") or [Hard Drives](/wiki/Hard_Drive "Hard Drive") in the trash
  * Removed velocity checks from [Ladders](/wiki/Ladder "Ladder") so you can always grab onto them
...
Update 3  
& Steam Release| [0.3.3.3](/wiki/Patch_0.3.3.3 "Patch 0.3.3.3") • [0.3.3.4](/wiki/Patch_0.3.3.4 "Patch 0.3.3.4") • [0.3.3.5](/wiki/Patch_0.3.3.5 "Patch 0.3.3.5") • [0.3.3.6](/wiki/Patch_0.3.3.6 "Patch 0.3.3.6") • [0.3.4.14](/wiki/Patch_0.3.4.14 "Patch 0.3.4.14") • [0.3.4.15](/wiki/Patch_0.3.4.15 "Patch 0.3.4.15") • [0.3.4.16](/wiki/Patch_0.3.4.16 "Patch 0.3.4.16") • [0.3.5](/wiki/Patch_0.3.5 "Patch 0.3.5") • [0.3.5.1](/wiki/Patch_0.3.5.1 "Patch 0.3.5.1") • [0.3.5.2](/wiki/Patch_0.3.5.2 "Patch 0.3.5.2") • [0.3.5.3](/wiki/Patch_0.3.5.3 "Patch 0.3.5.3") • [0.3.5.4](/wiki/Patch_0.3.5.4 "Patch 0.3.5.4") • [0.3.5.6](/wiki/Patch_0.3.5.6 "Patch 0.3.5.6") • 0.3.6.5 • [0.3.7](/wiki/Patch_0.3.7 "Patch 0.3.7") • [0.3.7.1](/wiki/Patch_0.3.7.1 "Patch 0.3.7.1") • [0.3.7.2](/wiki/Patch_0.3.7.2 "Patch 0.3.7.2") • [0.3.7.3](/wiki/Patch_0.3.7.3 "Patch 0.3.7.3") • [0.3.7.4](/wiki/Patch_0.3.7.4 "Patch 0.3.7.4") • [0.3.7.5](/wiki/Patch_0.3.7.5 "Patch 0.3.7.5") • [0.3.7.6](/wiki/Patch_0.3.7.6 "Patch 0.3.7.6") • [0.3.7.7](/wiki/Patch_0.3.7.7 "Patch 0.3.7.7")  
