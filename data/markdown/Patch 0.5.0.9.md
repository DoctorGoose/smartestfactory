...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.5.0.9** – Build 172651. This patch was released on 15 November 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/909832496881999962), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/qujeax), and [Steam](https://store.steampowered.com/news/app/526870/view/4316132205199010239). 
...
## Bug fixes
  ...
  * Fixed crash when selecting [Inverted Ramps](/wiki/Ramp "Ramp") (and added a bit of future proofing so it doesnt happen again)
  * Potential fix for a [Multiplayer](/wiki/Multiplayer "Multiplayer") / [Dedicated servers](/wiki/Dedicated_servers "Dedicated servers") crash related to [tireconfig](/wiki/Unreal_Engine "Unreal Engine") deletion
  ...
  * Made text prompts on [Quick Switch](/wiki/Controls "Controls") [`E`](/wiki/Controls "Controls") more consistent
  * Fixed the + and - buttons on the [To-Do List](/wiki/To-Do_List "To-Do List") being highlighted by default when adding items to the list
  * Fixed [Vehicle](/wiki/Vehicle "Vehicle") paths selected from the "All Vehicle Path" tab made by a different vehicle remaining selected when returning to the "Load Vehicle Path" tab
  ...
  * Fixed broken [Water Extractor](/wiki/Water_Extractor "Water Extractor") Snapping (This time for real)
  * Fixed so [Customizer Patterns](/wiki/Customizer#Patterns "Customizer") are no longer rotated based on foundation rotation (Double for real)
  * Another potential fix for some of the [foliage](/wiki/Flora "Flora") not being able to be picked up/chainsawed in [Northern Forest and Rocky Desert/Dune Desert](/wiki/World "World")
  * Fixed [Pipeline Pump Mk.1](/wiki/Pipeline_Pump_Mk.1 "Pipeline Pump Mk.1") not playing sounds
  * Actually fixed invisible [Conveyor Belts](/wiki/Conveyor_Belts "Conveyor Belts"), [Conveyor Lifts](/wiki/Conveyor_Lifts "Conveyor Lifts") and [Pipelines](/wiki/Pipelines "Pipelines") sometimes being invisible for Clients (Triple for real!!!)
  * Fixed so [Beams](/wiki/Beams "Beams") properly align their rotations with snapped Foundations
  * Fixed Beam connectors snapping to the sides of Beams
  * Fixed issues with Beams and [Pillar](/wiki/Pillars "Pillars") snapping
  * Fixed issues when upgrading [Buildings](/wiki/Buildings "Buildings")
  * [Stackable Pipe](/wiki/Pipeline_Supports "Pipeline Supports") and [Hyper Tube supports](/wiki/Hypertube_Supports "Hypertube Supports") now also properly increase cost in UI when zooping
  * Fixed Conveyor Lifts not properly snapping
  * Updated [Large Billboard](/wiki/Signs "Signs") to line up with other signs when placed
  * Fixed a Conveyor Lift visual bug when snapping through [Floor Holes](/wiki/Conveyor_Poles#Floor-0 "Conveyor Poles")
  * Fixed Signs being able to be placed on weird rotations on Pillars
  * Fixed some general [hologram placement](/wiki/Build_Gun "Build Gun") logic
...
## Quality of Life
  ...
  * Added "Misophonia Mode" under [Audio Options](/wiki/Settings#Audio "Settings"), this will replace "munching" sounds with sounds not generated or connected to human interactions
  * You can now press F to manually dock a vehicle on a [Truck Station](/wiki/Truck_Station "Truck Station")
  * Added a volume slider for "Manual Mining" under [Equipment Volume](/wiki/Settings#Audio "Settings")
  * Added tooltips to Vehicle [station](/wiki/Truck_Station "Truck Station") elements (Hover over)
  * Quite significantly increased [network scalability options](/wiki/Settings#General "Settings"). This should help with excessive load times on larger saves and for players who have never modified their network settings. (Gameplay > Network Quality)
  * Improved feedback when purchasing an item on the [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop")
  * Added "Other" as a Category on the [Signs](/wiki/Signs "Signs") Image Browser sub-menu, Added Emotes and CheckIt Icons to it
