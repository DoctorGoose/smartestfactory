...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.5.0.2** – Build 170426. This patch was released on 27 October 2021.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/902994239519064155), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/qh3rrd), and [Steam](https://store.steampowered.com/news/app/526870/view/3095655347288647555). 
...
The patch was rolled back soon after release with the following message: 

    This patch has been temporarily rolled back due to a crash on load/new game, we're preparing a hotfix for this hotfix :)

Its content, including the crash fix, was released about two hours later as [Patch 0.5.0.3](/wiki/Patch_0.5.0.3 "Patch 0.5.0.3"). 
...
There are more fixes to more stuff in the works but for now hopefully these make for a better experience, We hope you’re all enjoying this new update, take it easy <3 

## Bug fixes

  * Fixed an issue where the [HUB](/wiki/HUB "HUB") would spam sounds during the tutorial phase
  * Fixed “Press _ to dock” message getting stuck when exiting the [Electric Locomotive](/wiki/Electric_Locomotive "Electric Locomotive")
  * Fixed a crash related to [conveyor](/wiki/Conveyor_Belts "Conveyor Belts") items
  * Potential fix for a [Sign](/wiki/Signs "Signs") related crash
  * Fixed being unable to close the Locomotive Menu with [`V`](/wiki/Controls "Controls")
  * Fixed grass being missing from [Rocky Desert](/wiki/World#Rocky_Desert "World") (and possibly other locations)
  * Fixed some shader bugs in the [AWESOME Sink](/wiki/AWESOME_Sink "AWESOME Sink") UI
  * Fixed [Building Status Indicator Lights](/wiki/Indicator_Light "Indicator Light") not working
  * Rolled back latest [Epic Online Services (EOS)](/wiki/Unreal_Engine "Unreal Engine") plugin to the previous version, this should solve all sorts of messages people are seeing when starting up the game, shouldn’t create any new issues
  * Fix for [Trains](/wiki/Trains "Trains") with [carts containing fluids](/wiki/Freight_Car "Freight Car") not being able to go up hills
  * Fixed [Multiplayer](/wiki/Multiplayer "Multiplayer") / [Dedicated Servers](/wiki/Dedicated_Servers "Dedicated Servers") Clients not being able to save or remove colour presets in the [Customizer](/wiki/Customizer "Customizer")
  ...
  * Patch 0.5.0.2 _(Released again in[Patch 0.5.0.3](/wiki/Patch_0.5.0.3 "Patch 0.5.0.3"))_:
