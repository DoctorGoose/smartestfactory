# Template:Temporal Illusion/Sandbox/MainSub
...
[[purge](https://satisfactory.wiki.gg/wiki/Template:Temporal_Illusion/Sandbox/MainSub?action=purge)]
...
`{{Temporal_Illusion/Sandbox/MainSub|Main|Format Type|Before Text|Note}}`
...
0\. `{{Temporal_Illusion/Sandbox/MainSub|Settings#Controller_2|0}}` results in: 
...
1\. `{{Temporal Illusion/Sandbox/MainSub|Settings#Controller_2|1|CONTROLS}}` results in: 
...
2\. `{{Temporal_Illusion/Sandbox/MainSub|Settings#Controller_2|2| |'''General > Select Controls''' settings}}` results in: 
...
3\. `{{Temporal Illusion/Sandbox/MainSub|Settings#Controller_2|3|CONTROLS|<u>General > Select Controls</u>}}` results in: 
...
4\. `{{Temporal Illusion/Sandbox/MainSub|Settings#Controller_2|4}}` results in: 
...
5\. `{{Temporal Illusion/Sandbox/MainSub|Settings#Controller_2|5|Controls}}` results in: 
...
6\. `{{Temporal Illusion/Sandbox/MainSub|Settings#Controller_2|6| |General > Select Controls}}` results in: 
...
7\. `{{Temporal Illusion/Sandbox/MainSub|Settings#Controller_2|7|controls|[[Settings#General_3|Settings > Controls > General]] and view '''Select Controls''' settings}}` results in: 
...
8\. `{{Temporal_Illusion/Sandbox/MainSub|Settings#Controller_2}}` results in: 
...
The above documentation is transcluded from [Template:Temporal Illusion/Sandbox/MainSub/doc](/wiki/Template:Temporal_Illusion/Sandbox/MainSub/doc "Template:Temporal Illusion/Sandbox/MainSub/doc"). ([edit](https://satisfactory.wiki.gg/wiki/Template:Temporal_Illusion/Sandbox/MainSub/doc?action=edit) | [history](https://satisfactory.wiki.gg/wiki/Template:Temporal_Illusion/Sandbox/MainSub/doc?action=history))
