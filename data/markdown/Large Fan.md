...
[](/wiki/File:Xeno-Zapper.png "Stub") | _This article is a[stub](/wiki/Category:Stubs "Category:Stubs"). You can help Satisfactory Wiki by [expanding it](https://satisfactory.wiki.gg/wiki/Large_Fan?action=edit)._  
---|---  
  
_This article is a[stub](/wiki/Category:Stubs "Category:Stubs"). You can help Satisfactory Wiki by [expanding it](https://satisfactory.wiki.gg/wiki/Large_Fan?action=edit)._  
...
[ ](/wiki/File:Large_Fan.png "Large Fan.png")

_Attaches to Foundations and Walls.  
While standard FICSIT factories circumvent the need to follow common airflow regulations, this building piece still adds to the factory ambience._

### Unlocked by

[AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Ventilation Bundle
...
**1 ×[](/wiki/Copper_Sheet "Copper Sheet") [Copper Sheet](/wiki/Copper_Sheet "Copper Sheet")**

## Large Vent

[ ](/wiki/File:Large_Vent.png "Large Vent.png")
...
The **Large Fan** and **Large Vent** are decorative structures which attach to [walls](/wiki/Walls "Walls"). They emit particles but otherwise serve no practical purpose other than being design elements. 

## History

  * [Patch 1.1.0.0](/wiki/Patch_1.1.0.0 "Patch 1.1.0.0"): Introduced
