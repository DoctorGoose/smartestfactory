...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.5.0.14** – Build 173618. This patch was released on 23 November 2021. Later on the same day, the patch was pushed to the stable Early Access branch as [Patch 0.5.1.0](/wiki/Patch_0.5.1.0 "Patch 0.5.1.0") with no changes, retaining the build number.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/912691667742650378), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/r0cwyq), and [Steam](https://store.steampowered.com/news/app/526870/view/3136189647427385463). 
...
## Bug fixes
  ...
  * Fixed [Wires](/wiki/Power_Line "Power Line") being completely stretched in certain scenarios
  * [Vehicles](/wiki/Vehicles "Vehicles") now try to stop ghosting as soon as possible when blocked
  * Fixed a calculation error when fuel is added manually
  * Added some preventions for [Trains](/wiki/Train "Train") falling out of the world when derailing
...
## UI
  ...
  * Directional arrows for the [Vehicle](/wiki/Vehicles "Vehicles") in the [Map](/wiki/Map "Map") preview when loading a Vehicle Path are now displayed from the centre of the Vehicle
  * Fixed [Double Ramp](/wiki/Foundations "Foundations") Asphalt Icons
...
## Quality of Life
  ...
  * Reduced [Train Switch](/wiki/Railroad_Switch_Control "Railroad Switch Control") size



## Dedicated servers

  * Found an issue where threading was forced to be disabled for [Dedicated servers](/wiki/Dedicated_servers "Dedicated servers") in some scenarios. Fixed it so now we should actually make use of multiple CPU cores
