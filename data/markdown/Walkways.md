...
[ ](/wiki/File:Walkway_Straight.png "Walkway Straight.png")

_Snaps to foundations and other walkways. Specifically made for humans to walk on._

### Unlocked by

[AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Industrial Walkways
...
**1×** [](/wiki/Iron_Plate "Iron Plate") [Iron Plate](/wiki/Iron_Plate "Iron Plate")

## Catwalk

[ ](/wiki/File:Catwalk_Straight.png "Catwalk Straight.png")

_Snaps to foundations and other walkways. Specifically made for humans to walk on._

### Unlocked by

[AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Modern Catwalks
...
“  | _Walkways are the best. They’re attached to the ground and everything._ | „   
---|---|---  
| ~ **Caterina Parks's assistant[Steve](/wiki/Steve "Steve")** |   
  
**Walkways** and **Catwalks** are navigational structures used to make safe and easy paths for the [pioneer](/wiki/Pioneer "Pioneer") to get around their factory. 
...
---|---|---|---|---|---|---|---|---  
Walkway  | [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Industrial Walkways | 2×[](/wiki/Iron_Rod "Iron Rod") [Iron Rod](/wiki/Iron_Rod "Iron Rod")  
1×[](/wiki/Iron_Plate "Iron Plate") [Iron Plate](/wiki/Iron_Plate "Iron Plate") |  |  |  |  |  | N/A   
Catwalk  | [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Modern Catwalks | 2×[](/wiki/Iron_Rod "Iron Rod") [Iron Rod](/wiki/Iron_Rod "Iron Rod")  
1×[](/wiki/Iron_Plate "Iron Plate") [Iron Plate](/wiki/Iron_Plate "Iron Plate") |  |  |  |  |  |   
  
## Construction

Walkways and Catwalks can be built one at a time or 10 at once using the [Zoop](/wiki/Build_Gun#Zoop "Build Gun") construction mode. 

Walkways and Catwalks are functionally identical (collectively referred to Walkways hereafter). Both can only be placed on the edge of a [foundation](/wiki/Foundation "Foundation") or [wall](/wiki/Wall "Wall"), or attach one to another. They cannot be placed freely. Each foundation edge has 3 snapping points for them. 

Foundations can also snap to Walkways, which allows the player to offset them in 2m increments. 

[Power Poles](/wiki/Power_Poles "Power Poles") and [Conveyor Poles](/wiki/Conveyor_Pole "Conveyor Pole") cannot be built on Walkways unless a foundation is built in the same tile. However, if a [Power Line](/wiki/Power_Line "Power Line") or [Belt](/wiki/Belt "Belt") is started from an existing structure, they _can_ be placed on Walkways, including on the railings. 

### Snapping

The following buildable's allow snapping of Walkways and Catwalks by default. Other buildable's can use foundations or walls to assist in placement. The [Space Elevator](/wiki/Space_Elevator "Space Elevator") upper platform can not be snapped to directly, despite the use of what appears to be walkway. 

  * [Constructor](/wiki/Constructor "Constructor")
  * [Foundry](/wiki/Foundry "Foundry")
  * [Refinery](/wiki/Refinery "Refinery")
  * [Blender](/wiki/Blender "Blender")
  * [Train Station](/wiki/Train_Station "Train Station")
  * [Lookout Tower](/wiki/Lookout_Tower "Lookout Tower")
  * [Power Tower](/wiki/Power_Tower#tabber-tabpanel-Platform-0 "Power Tower") with platform.
  * [Coal-Powered Generator](/wiki/Coal-Powered_Generator "Coal-Powered Generator")
  * [Fuel-Powered Generator](/wiki/Fuel-Powered_Generator "Fuel-Powered Generator")
  * [Nuclear Power Plant](/wiki/Nuclear_Power_Plant "Nuclear Power Plant")
  * [Particle Accelerator](/wiki/Particle_Accelerator "Particle Accelerator")
...
## See also
  ...
  * [Ramps](/wiki/Ramps "Ramps")



## Gallery

  * [](/wiki/File:Foundations_and_Walkways.png "Using some walkways to climb up a factory.")

Using some walkways to climb up a factory.

  * [](/wiki/File:Walkways_on_Foundations.png "Using walkways to cross multiple belts and over other infrastructures.")

Using walkways to cross multiple belts and over other infrastructures.
...
## History
  ...
  * [Patch 0.7.0.5](/wiki/Patch_0.7.0.5 "Patch 0.7.0.5"): Now affect Blueprint size
  * [Patch 0.6.1.2](/wiki/Patch_0.6.1.2 "Patch 0.6.1.2"): Fixed various Walkway snapping issues
  * [Patch 0.5.0.0](/wiki/Patch_0.5.0.0 "Patch 0.5.0.0"): 
    * Introduced Catwalks for Straight, Corner, T-Crossing, Crossing, Ramp, and Stairs
    * Now can snap to walls
  * [Patch 0.3](/wiki/Patch_0.3 "Patch 0.3"): Walkways are now unlocked in the [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") instead of by a [Tier 2](/wiki/Tier_2 "Tier 2") milestone - "Walkways".
...
Architecture| [](/wiki/Frame_Structures "Frame Structures") [Frames](/wiki/Frame_Structures "Frame Structures") • [](/wiki/Roofs "Roofs") [Roofs](/wiki/Roofs "Roofs") • [](/wiki/Beams "Beams") [Beams](/wiki/Beams "Beams") • [](/wiki/Pillars "Pillars") [Pillars](/wiki/Pillars "Pillars") • [](/wiki/Walkways "Walkways") Walkways • [](/wiki/Walls "Walls") [Railings](/wiki/Walls "Walls") • [](/wiki/Foundations#Stairs "Foundations") [Stairs](/wiki/Foundations#Stairs "Foundations") • [](/wiki/Ladder "Ladder") [Ladder](/wiki/Ladder "Ladder") • [](/wiki/Large_Fan "Large Fan") [Large Fan](/wiki/Large_Fan "Large Fan") ([Vent](/wiki/Large_Vent "Large Vent"))
