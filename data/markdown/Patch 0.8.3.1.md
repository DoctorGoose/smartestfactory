...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.8.3.1** – Build 268809. This patch was released on 23 November 2023.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1177312612535517184), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/1827fh0), and [Steam](https://store.steampowered.com/news/app/526870/view/3856832085209285434). 
...
## QoL
  ...
  * [Invert Look](/wiki/Settings#Controls "Settings") option now also works on [Vehicles](/wiki/Vehicles "Vehicles") and [Trains](/wiki/Trains "Trains")



## UI

  * Updated the description of the [Maintain Y-Axis FOV Aspect Ratio](/wiki/Settings#Camera_2 "Settings") option to indicate that it is broken 
...
## Bug fixes
  ...
  * Potential fix to a crash related to [ItemRegrow subsystem](/wiki/Unreal_Engine "Unreal Engine")
  * Fixed CTRL Key getting stuck when [building](/wiki/Build_Gun "Build Gun")
  ...
  * Fixed bug where [Hand Mining](/wiki/Controls "Controls") (using [`E`](/wiki/Controls "Controls")) would sometimes get stuck as [client](/wiki/Multiplayer "Multiplayer")
  * Fixed [Conveyor Belts](/wiki/Conveyor_Belts "Conveyor Belts") resetting to default customization when the belt was split
  * Fixed a bug where it was sometimes impossible to hand mine near [Gas Pillars](/wiki/Gas_Pillar "Gas Pillar")
