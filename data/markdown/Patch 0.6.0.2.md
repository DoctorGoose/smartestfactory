...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.6.0.2** – Build 192789. This patch was released on 15 June 2022.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/986736632608731196), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/vd4iid), and [Steam](https://store.steampowered.com/news/app/526870/view/3321982156729884876). 
...
## Bug fixes
  ...
  * Fixed [Mk.2 Pipes](/wiki/Pipelines "Pipelines") not having an indicator
  * Fixed production VFX not being properly started for the [Nuclear Generator](/wiki/Nuclear_Power_Plant "Nuclear Power Plant")
  * Potentially fixed a crash for the Nuclear Generator particle effects
  * Fixed [Spore Flowers](/wiki/Spore_Flower "Spore Flower") not being destructible
  * Fixed interacting with a [Player Crate](/wiki/Crate "Crate") locking player input
...
## World
  ...
  * Fixed some [Bauxite](/wiki/Bauxite "Bauxite") [nodes](/wiki/Resource_Node "Resource Node") that were missing
  * Fixed a [Uranium](/wiki/Uranium "Uranium") node that was missing



## UI

  * [Map](/wiki/Map "Map") Objects are no longer clickable when placing Markers/Stamps, this now means you can place Markers/Stamps on top of other Map Objects (Such as the player, vehicles, other Markers/Stamps, etc.)
  * Fixed an issue where the Map Coordinates and placing Stamps/Markers wasn’t working properly when using UI scaling
  * Fixed [Truck Station](/wiki/Truck_Station "Truck Station") inventories not being visible
  * Fixed [[Pipelines|Pipe] flow rate not being properly displayed
  * Fixed Resources not being shown to [Multiplayer](/wiki/Multiplayer "Multiplayer") Clients or [Dedicated Server](/wiki/Dedicated_Server "Dedicated Server") Clients when opening the Map or [Radar Tower](/wiki/Radar_Tower "Radar Tower")
  * Fixed the highlighted map markers not being shown on the [compass](/wiki/HUD#Compass "HUD")
