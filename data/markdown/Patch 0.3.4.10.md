...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.3.4.10** – Build 122346. This patch was released on 18 May 2020.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/711970536116453468) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/gm43jj). 
...
## Balancing
  ...
  * Moved one of the [Rocky Desert](/wiki/Rocky_Desert "Rocky Desert") new game spawning positions to a better location



## Creatures

  * Increased the size of [Flying Crabs](/wiki/Flying_Crab "Flying Crab") to make them easier to hit and track
...
## UI
  ...
  * Added an additional [onboarding](/wiki/Onboarding "Onboarding") step highlighting the [Codex](/wiki/Codex "Codex")
...
## Bug fixes
  ...
  * Better LOD timing for [Glass Foundations](/wiki/Glass_Foundation "Glass Foundation") (they should pop less)
  * Fixed up some [Limestone](/wiki/Limestone "Limestone") [Resource Node](/wiki/Resource_Node "Resource Node") locations
  * Fixed a crash on load with assert for IsInParallelRenderingThread and IsInRenderThread
  * [Conveyor Belt](/wiki/Conveyor_Belt "Conveyor Belt") mesh no longer shows up before the Build Effect is played
...
## Unannounced changes
  ...
  * [Portable Miner](/wiki/Portable_Miner "Portable Miner"): 
    * Changed [Iron Plate](/wiki/Iron_Plate "Iron Plate") cost from 3 to 2
    * Changed [Iron Rod](/wiki/Iron_Rod "Iron Rod") cost from 3 to 4
  * [Equipment Workshop](/wiki/Equipment_Workshop "Equipment Workshop"): 
    * Changed [Iron Plate](/wiki/Iron_Plate "Iron Plate") cost from 5 to 6
    * Changed [Iron Rod](/wiki/Iron_Rod "Iron Rod") cost from 5 to 4
