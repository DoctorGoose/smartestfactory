...
Patch Notes: **v1.0.0.5** – Build 377620. This patch was released on 4 November 2024.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1303025926119882843), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/1gjhnsd), and [Steam](https://store.steampowered.com/news/app/526870/view/4476108195413098876). 
...
## Gameplay
  ...
  * Re-added the clearance visualization boxes on [Buildings](/wiki/Buildings "Buildings")
    * Can now be enabled in the [Options](/wiki/Options "Options") menu > Gameplay > General > Show Clearance



## Bugfixes

  * Optimized the [Lightweight Subsystem](/wiki/Unreal_Engine#Lightweight_Actors "Unreal Engine"), this improves a bug where hovering over big [blueprint](/wiki/Blueprint "Blueprint") holograms over existing buildables would drastically lower performance until the hologram was closed
  * Fixed a bug where taming enough [Lizard Doggos](/wiki/Lizard_Doggo "Lizard Doggo") would make other [creatures](/wiki/Creatures "Creatures") disappear
  * Added Equip/Unequip sounds for the [Jetpack](/wiki/Jetpack "Jetpack")
  * Fixed a bug where it was possible to merge a [Pipeline](/wiki/Pipeline "Pipeline") or a [Conveyor Belt](/wiki/Conveyor_Belt "Conveyor Belt") into itself by using a [Pipeline Junction](/wiki/Pipeline_Junction "Pipeline Junction") or [Splitter](/wiki/Splitter "Splitter")/[Merger](/wiki/Merger "Merger"), which would cause duplications
  * Fix for Pipelines losing connection to [Pipeline Floor Holes](/wiki/Pipeline_Floor_Hole "Pipeline Floor Hole") when Upgrading/Downgrading them
  * Fixed a bug where [Nudging](/wiki/Build_Gun#Hologram_lock_and_nudge_mode "Build Gun") would stop working for the player Hosting the session in [Multiplayer](/wiki/Multiplayer "Multiplayer")
  * Fixed a bug where leaving a session without respawning would result in them losing their [Inventory](/wiki/Inventory "Inventory") when rejoining
  * Fixed [Power Pole](/wiki/Power_Pole "Power Pole") Clearance
  * Fixed players not being able to mine [resource deposits](/wiki/Resource_Node#Resource_Deposit "Resource Node") inside of the [Spore Flower](/wiki/Spore_Flower "Spore Flower") Gas
  * Fixed not being able to [sample buildings](/wiki/Build_Gun#Building_eyedropper "Build Gun") sometimes after saving and reloading a session
  * Fixed a rare Crash in Multiplayer when someone in the session enters a [Vehicle](/wiki/Vehicle "Vehicle")
  * Fixed [Blueprint Designer](/wiki/Blueprint_Designer "Blueprint Designer") Storage Container not properly displaying
  * Potential fix for a crash in the [Circuit Subsystem](/wiki/Power "Power")
  * Fixed crashes related to dismantling some parts of a [Blueprint](/wiki/Blueprint "Blueprint"), mostly affecting [Conveyor Belts](/wiki/Conveyor_Belt "Conveyor Belt"), [Pipelines](/wiki/Pipeline "Pipeline") and [Railways](/wiki/Railway "Railway")
  * Fixed a bug where loading a [Blueprint](/wiki/Blueprint "Blueprint") in a designer would load it in all the previously interacted designers
  * Fixed a crash related to Blueprint connections when exiting or loading a save
  * All of the remaining smoke effect lingering from [Gas Pillars](/wiki/Gas_Pillar "Gas Pillar") should now be fixed
  * Fixed “Efficiency first” (Unlock All [Milestones](/wiki/Milestones "Milestones")) [achievement](/wiki/Achievements "Achievements") not unlocking correctly on Epic Games Launcher
  * Fixed [Ascend/Descend](/wiki/Controls "Controls") inputs getting stuck when opening a menu while using the [Hoverpack](/wiki/Hoverpack "Hoverpack")
  * Fixed [Locomotives](/wiki/Electric_Locomotive "Electric Locomotive") moving on railways displaying incorrectly in multiplayer in some scenarios
  * Fixed [Drone Stations](/wiki/Drone_Port "Drone Port") displaying incorrect names in the UI and incorrectly allowing duplicate names for stations
  * Fixed [Train Signals](/wiki/Train_Signals "Train Signals") disconnecting from the track when placing them in Multiplayer
...
## [Dedicated servers](/wiki/Dedicated_servers "Dedicated servers")
  ...
  * Fixed [Advanced Game Settings](/wiki/Advanced_Game_Settings "Advanced Game Settings") being activated unintentionally transferring from the current save to another when starting a new session through the Server Manager
