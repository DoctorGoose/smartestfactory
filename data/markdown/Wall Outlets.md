...
**Wall Outlets** are wall- and ceiling-mounted connection points for [Power Lines](/wiki/Power_Line "Power Line"). Akin to [Power Poles](/wiki/Power_Poles "Power Poles"), they can be used to transfer power alongside or inside buildings. Unlike Power Poles, they cannot be interacted with to view the [power graph](/wiki/Power#Power_graph "Power") or reset the fuse. 
...
Wall OutletsDouble Wall Outlets

Type | Unlocked at | Cost   
---|---|---  
Coupons | Resources   
[](/wiki/File:Wall_Outlet_Mk.1.png) Wall Outlet Mk.1 | [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Wall Outlets Mk.1 | 3 | 4x[](/wiki/Wire "Wire") [Wire](/wiki/Wire "Wire")  
1x[](/wiki/Iron_Rod "Iron Rod") [Iron Rod](/wiki/Iron_Rod "Iron Rod")  
[](/wiki/File:Wall_Outlet_Mk.2.png) Wall Outlet Mk.2 | [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Wall Outlets Mk.2 | 4 | 8x[](/wiki/Quickwire "Quickwire") [Quickwire](/wiki/Quickwire "Quickwire")  
2x[](/wiki/Iron_Rod "Iron Rod") [Iron Rod](/wiki/Iron_Rod "Iron Rod")  
[](/wiki/File:Wall_Outlet_Mk.3.png) Wall Outlet Mk.3 | [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Wall Outlets Mk.3 | 5 | 3x[](/wiki/High-Speed_Connector "High-Speed Connector") [High-Speed Connector](/wiki/High-Speed_Connector "High-Speed Connector")  
3x[](/wiki/Steel_Pipe "Steel Pipe") [Steel Pipe](/wiki/Steel_Pipe "Steel Pipe")  
  
Type | Unlocked at | Cost   
---|---|---  
Coupons | Resources   
[](/wiki/File:Double_Wall_Outlet_Mk.1.png) Double Wall Outlet Mk.1 | [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Wall Outlets Mk.1 | 3 | 8x[](/wiki/Wire "Wire") [Wire](/wiki/Wire "Wire")  
2x[](/wiki/Iron_Rod "Iron Rod") [Iron Rod](/wiki/Iron_Rod "Iron Rod")  
[](/wiki/File:Double_Wall_Outlet_Mk.2.png) Double Wall Outlet Mk.2 | [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Wall Outlets Mk.2 | 4 | 16x[](/wiki/Quickwire "Quickwire") [Quickwire](/wiki/Quickwire "Quickwire")  
8x[](/wiki/Iron_Rod "Iron Rod") [Iron Rod](/wiki/Iron_Rod "Iron Rod")  
[](/wiki/File:Double_Wall_Outlet_Mk.3.png) Double Wall Outlet Mk.3 | [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Wall Outlets Mk.3 | 5 | 6x[](/wiki/High-Speed_Connector "High-Speed Connector") [High-Speed Connector](/wiki/High-Speed_Connector "High-Speed Connector")  
6x[](/wiki/Steel_Pipe "Steel Pipe") [Steel Pipe](/wiki/Steel_Pipe "Steel Pipe")  
  
## Obtaining

Each mark of Wall Outlets becomes available in the [AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") after their corresponding tier of [Power Pole](/wiki/Power_Pole "Power Pole") is unlocked in the [Caterium Research tree](/wiki/MAM#Caterium "MAM"). 

## Construction

  * Wall Outlets can be placed separately or when aiming at a wall or ceiling while extending a Power Line.
...
## See also
  ...
  * [](/wiki/Power_Tower "Power Tower") [Power Tower](/wiki/Power_Tower "Power Tower")
  * [](/wiki/Power_Switch "Power Switch") [Power Switch](/wiki/Power_Switch "Power Switch")
  * [](/wiki/Priority_Power_Switch "Priority Power Switch") [Priority Power Switch](/wiki/Priority_Power_Switch "Priority Power Switch")



## History

  * [Patch 0.8.0.5](/wiki/Patch_0.8.0.5 "Patch 0.8.0.5")
    * Fixed Wall Outlets Wall Outlets not snapping to Beams and Pillars
    * Fixed Wall Outlets not allowing 45 degree rotation
  * [Patch 0.6.0.5](/wiki/Patch_0.6.0.5 "Patch 0.6.0.5"): Wall Outlets can now snap to and be built on existing Power Lines
  * [Patch 0.3.6.5](/wiki/Patch_0.3.6.5 "Patch 0.3.6.5"): Wall attachments can now be placed under and on the side of Foundations (Power/Pipeline/Hyper Tube Wall attachments)
  * [Patch 0.3.4.0](/wiki/Patch_0.3.4.0 "Patch 0.3.4.0"): Renamed Wall Power Poles to Wall Outlets
  * [Patch 0.3.1.0](/wiki/Patch_0.3.1.0 "Patch 0.3.1.0"): 
...
## Gallery
  ...
  * [](/wiki/File:Pipeline_Pumps_on_Walls.png "Wall Outlets can be used to distribute Power vertically for buildings on walls.")

Wall Outlets can be used to distribute [Power](/wiki/Power "Power") vertically for buildings on [walls](/wiki/Wall "Wall").

  * [](/wiki/File:Factory_exterior.png "Wall Outlets being used to route power alongside buildings.")

Wall Outlets being used to route power alongside buildings.
