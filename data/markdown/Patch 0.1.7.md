...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.1.7** – Build 98611. This patch was released on 7 May 2019.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/575339742602854410) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/blrx0a). 
...
## Balancing
  ...
  * Adjusted the Alternate Recipe for [Compacted Coal](/wiki/Compacted_Coal "Compacted Coal")
    * Old: 2 Coal + 2 Sulphur
    * New: 3 Coal + 3 Sulphur
  * Adjusted the Alternate Recipe for [Turbo Fuel](/wiki/Turbofuel "Turbofuel")
...
## Bug fixes
  ...
  * Fixed not being able to build [Conveyor Lifts](/wiki/Conveyor_Lift "Conveyor Lift") downward onto [Foundations](/wiki/Foundations "Foundations")
  * Fixed the Stackable Conveyor Pole not aligning with other Conveyor Connections
  * Unpossessed Player Characters that are killed or already dead now spawn Death [Crates](/wiki/Crate "Crate")



## UI

  * Updated some [Map](/wiki/Map "Map") icons
  * Polished [Radar Tower](/wiki/Radar_Tower "Radar Tower") menu
...
Experimental Update 1| [0.1.5](/wiki/Patch_0.1.5 "Patch 0.1.5") • [0.1.6 (98394)](/wiki/Patch_0.1.6_build_98394 "Patch 0.1.6 build 98394") • [0.1.6 (98445)](/wiki/Patch_0.1.6_build_98445 "Patch 0.1.6 build 98445") • 0.1.7 • [0.1.8](/wiki/Patch_0.1.8 "Patch 0.1.8") • [0.1.9](/wiki/Patch_0.1.9 "Patch 0.1.9") • [0.1.10](/wiki/Patch_0.1.10 "Patch 0.1.10")  
