...
Patch Notes: **v1.0.0.6** – Build 378208. This patch was released on 7 November 2024.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/1304036023004565536), [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/1glnqf1), and [Steam](https://store.steampowered.com/news/app/526870/view/4456968534728114275). 

## Intro

Hi Pioneers! 

This week we pushed a patch that contained a pretty chonky issue, namely that a lot of stuff on the map respawned. This hotfix will address this issue, however, if you’ve saved your game since this last patch ([1.0.0.5](/wiki/Patch_1.0.0.5 "Patch 1.0.0.5")) then your save file will still have most items respawned. I.e. this hotfix will not revert the damage done from the last patch if you’ve already saved over it (sowee!). We’ve also resolved the issues related to the customizer with this hotfix! 
...
## Bugfixes
  ...
  * Fixed so that items don’t respawn when loading [save files](/wiki/Save_files "Save files") created in [1.0.0.4](/wiki/Patch_1.0.0.4 "Patch 1.0.0.4")
  * Fixed issues where the [Customizer](/wiki/Customizer "Customizer") would incorrectly apply customization
