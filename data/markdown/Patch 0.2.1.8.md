...
Patch Notes: Early Access (EXPERIMENTAL) – **v0.2.1.8** – Build 102736. This patch was released on 2 August 2019.   
  
The original post can be viewed on Satisfactory's [Discord](https://discord.com/channels/370472939054956546/557603412565426196/606832487745978368) and [Reddit](https://www.reddit.com/r/SatisfactoryGame/comments/cl3r7a). 
...
We’ve got another update with some fixes and optimisation for you, coming in on Experimental! We are also trying out another new feature for the Map/Compass, which is setting the view distance for Beacons. Near, far, wherever you are. The plan for this update is to be on Experimental over the weekend to catch potential issues (particularly with the optimisations) and push it to Early Access early next week when we deem it stable. 
