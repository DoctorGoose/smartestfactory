...
[[purge](https://satisfactory.wiki.gg/wiki/Template:MainSub?action=purge)]
...
`{{MainSub|Main|Format Type|Before Text|Note}}`
...
0\. `{{MainSub|Settings#Controller_2|0}}` results in: 
...
1\. `{{MainSub|Settings#Controller_2|1|CONTROLS}}` results in: 
...
2\. `{{MainSub|Settings#Controller_2|2| |'''General > Select Controls''' settings}}` results in: 
...
3\. `{{MainSub|Settings#Controller_2|3|CONTROLS|<u>General > Select Controls</u>}}` results in: 
...
4\. `{{MainSub|Settings#Controller_2|4}}` results in: 
...
5\. `{{MainSub|Settings#Controller_2|5|Controls}}` results in: 
...
6\. `{{MainSub|Settings#Controller_2|6| |General > Select Controls}}` results in: 
...
7\. `{{MainSub|Settings#Controller_2|7|controls|[[Settings#General_3|Settings > Controls > General]] and view '''Select Controls''' settings}}` results in: 
...
8\. `{{MainSub|Settings#Controller_2}}` results in: 
...
The above documentation is transcluded from [Template:MainSub/doc](/wiki/Template:MainSub/doc "Template:MainSub/doc"). ([edit](https://satisfactory.wiki.gg/wiki/Template:MainSub/doc?action=edit) | [history](https://satisfactory.wiki.gg/wiki/Template:MainSub/doc?action=history))
