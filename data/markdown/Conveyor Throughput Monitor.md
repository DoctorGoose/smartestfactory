...
[ ](/wiki/File:Conveyor_Throughput_Monitor.png "Conveyor Throughput Monitor.png")

_Attaches to Conveyor Belts.  
Monitors the number of parts travelling through it and displays the average throughput per minute.  
NOTE: Requires a full minute of data before complete accuracy is achieved._

### Unlocked by

[AWESOME Shop](/wiki/AWESOME_Shop "AWESOME Shop") \- Conveyor Throughput Monitor
...
**4 ×[](/wiki/Reinforced_Iron_Plate "Reinforced Iron Plate") [Reinforced Iron Plate](/wiki/Reinforced_Iron_Plate "Reinforced Iron Plate")**

**10 ×[](/wiki/Quartz_Crystal "Quartz Crystal") [Quartz Crystal](/wiki/Quartz_Crystal "Quartz Crystal")**

**1 ×[](/wiki/Crystal_Oscillator "Crystal Oscillator") [Crystal Oscillator](/wiki/Crystal_Oscillator "Crystal Oscillator")**

The **Conveyor Throughput Monitor** is a [Conveyor Belt](/wiki/Conveyor_Belt "Conveyor Belt") attachment that measures the real-time throughput of the conveyor it is attached to. 
...
Externally, it displays a rolling average of the past minute. It can be interacted with to display a chart. 

## Gallery

  * [](/wiki/File:Conveyor_Throughput_Monitor_UI.jpg "Graph shown when interacting with a Conveyor Throughput Monitor")

Graph shown when interacting with a Conveyor Throughput Monitor
